(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();function La(t,e){const n=Object.create(null),i=t.split(",");for(let r=0;r<i.length;r++)n[i[r]]=!0;return e?r=>!!n[r.toLowerCase()]:r=>!!n[r]}const se={},qn=[],ot=()=>{},Tp=()=>!1,Sp=/^on[^a-z]/,Ps=t=>Sp.test(t),$a=t=>t.startsWith("onUpdate:"),pe=Object.assign,Fa=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Op=Object.prototype.hasOwnProperty,V=(t,e)=>Op.call(t,e),N=Array.isArray,Kn=t=>Ns(t)==="[object Map]",Wf=t=>Ns(t)==="[object Set]",F=t=>typeof t=="function",ge=t=>typeof t=="string",Ua=t=>typeof t=="symbol",oe=t=>t!==null&&typeof t=="object",Vf=t=>oe(t)&&F(t.then)&&F(t.catch),zf=Object.prototype.toString,Ns=t=>zf.call(t),Rp=t=>Ns(t).slice(8,-1),Gf=t=>Ns(t)==="[object Object]",Ba=t=>ge(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Kr=La(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ms=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Ap=/-(\w)/g,ii=Ms(t=>t.replace(Ap,(e,n)=>n?n.toUpperCase():"")),xp=/\B([A-Z])/g,xn=Ms(t=>t.replace(xp,"-$1").toLowerCase()),qf=Ms(t=>t.charAt(0).toUpperCase()+t.slice(1)),mo=Ms(t=>t?`on${qf(t)}`:""),Ji=(t,e)=>!Object.is(t,e),Yr=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},is=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},qo=t=>{const e=parseFloat(t);return isNaN(e)?t:e},kp=t=>{const e=ge(t)?Number(t):NaN;return isNaN(e)?t:e};let Lc;const Ko=()=>Lc||(Lc=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function kn(t){if(N(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],r=ge(i)?Dp(i):kn(i);if(r)for(const s in r)e[s]=r[s]}return e}else{if(ge(t))return t;if(oe(t))return t}}const Pp=/;(?![^(]*\))/g,Np=/:([^]+)/,Mp=/\/\*[^]*?\*\//g;function Dp(t){const e={};return t.replace(Mp,"").split(Pp).forEach(n=>{if(n){const i=n.split(Np);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function ke(t){let e="";if(ge(t))e=t;else if(N(t))for(let n=0;n<t.length;n++){const i=ke(t[n]);i&&(e+=i+" ")}else if(oe(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Lp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",$p=La(Lp);function Kf(t){return!!t||t===""}const jt=t=>ge(t)?t:t==null?"":N(t)||oe(t)&&(t.toString===zf||!F(t.toString))?JSON.stringify(t,Yf,2):String(t),Yf=(t,e)=>e&&e.__v_isRef?Yf(t,e.value):Kn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,r])=>(n[`${i} =>`]=r,n),{})}:Wf(e)?{[`Set(${e.size})`]:[...e.values()]}:oe(e)&&!N(e)&&!Gf(e)?String(e):e;let et;class Fp{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=et,!e&&et&&(this.index=(et.scopes||(et.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=et;try{return et=this,e()}finally{et=n}}}on(){et=this}off(){et=this.parent}stop(e){if(this._active){let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.scopes)for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0,this._active=!1}}}function Up(t,e=et){e&&e.active&&e.effects.push(t)}function Bp(){return et}const Ha=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Xf=t=>(t.w&Xt)>0,Qf=t=>(t.n&Xt)>0,Hp=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Xt},jp=t=>{const{deps:e}=t;if(e.length){let n=0;for(let i=0;i<e.length;i++){const r=e[i];Xf(r)&&!Qf(r)?r.delete(t):e[n++]=r,r.w&=~Xt,r.n&=~Xt}e.length=n}},Yo=new WeakMap;let Bi=0,Xt=1;const Xo=30;let tt;const vn=Symbol(""),Qo=Symbol("");class ja{constructor(e,n=null,i){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Up(this,i)}run(){if(!this.active)return this.fn();let e=tt,n=Wt;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=tt,tt=this,Wt=!0,Xt=1<<++Bi,Bi<=Xo?Hp(this):$c(this),this.fn()}finally{Bi<=Xo&&jp(this),Xt=1<<--Bi,tt=this.parent,Wt=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){tt===this?this.deferStop=!0:this.active&&($c(this),this.onStop&&this.onStop(),this.active=!1)}}function $c(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Wt=!0;const Jf=[];function pi(){Jf.push(Wt),Wt=!1}function gi(){const t=Jf.pop();Wt=t===void 0?!0:t}function Fe(t,e,n){if(Wt&&tt){let i=Yo.get(t);i||Yo.set(t,i=new Map);let r=i.get(n);r||i.set(n,r=Ha()),Zf(r)}}function Zf(t,e){let n=!1;Bi<=Xo?Qf(t)||(t.n|=Xt,n=!Xf(t)):n=!t.has(tt),n&&(t.add(tt),tt.deps.push(t))}function Ot(t,e,n,i,r,s){const o=Yo.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&N(t)){const l=Number(i);o.forEach((c,u)=>{(u==="length"||u>=l)&&a.push(c)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":N(t)?Ba(n)&&a.push(o.get("length")):(a.push(o.get(vn)),Kn(t)&&a.push(o.get(Qo)));break;case"delete":N(t)||(a.push(o.get(vn)),Kn(t)&&a.push(o.get(Qo)));break;case"set":Kn(t)&&a.push(o.get(vn));break}if(a.length===1)a[0]&&Jo(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);Jo(Ha(l))}}function Jo(t,e){const n=N(t)?t:[...t];for(const i of n)i.computed&&Fc(i);for(const i of n)i.computed||Fc(i)}function Fc(t,e){(t!==tt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const Wp=La("__proto__,__v_isRef,__isVue"),eh=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Ua)),Vp=Wa(),zp=Wa(!1,!0),Gp=Wa(!0),Uc=qp();function qp(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const i=G(this);for(let s=0,o=this.length;s<o;s++)Fe(i,"get",s+"");const r=i[e](...n);return r===-1||r===!1?i[e](...n.map(G)):r}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){pi();const i=G(this)[e].apply(this,n);return gi(),i}}),t}function Kp(t){const e=G(this);return Fe(e,"has",t),e.hasOwnProperty(t)}function Wa(t=!1,e=!1){return function(i,r,s){if(r==="__v_isReactive")return!t;if(r==="__v_isReadonly")return t;if(r==="__v_isShallow")return e;if(r==="__v_raw"&&s===(t?e?ug:sh:e?rh:ih).get(i))return i;const o=N(i);if(!t){if(o&&V(Uc,r))return Reflect.get(Uc,r,s);if(r==="hasOwnProperty")return Kp}const a=Reflect.get(i,r,s);return(Ua(r)?eh.has(r):Wp(r))||(t||Fe(i,"get",r),e)?a:Re(a)?o&&Ba(r)?a:a.value:oe(a)?t?oh(a):Ga(a):a}}const Yp=th(),Xp=th(!0);function th(t=!1){return function(n,i,r,s){let o=n[i];if(ri(o)&&Re(o)&&!Re(r))return!1;if(!t&&(!rs(r)&&!ri(r)&&(o=G(o),r=G(r)),!N(n)&&Re(o)&&!Re(r)))return o.value=r,!0;const a=N(n)&&Ba(i)?Number(i)<n.length:V(n,i),l=Reflect.set(n,i,r,s);return n===G(s)&&(a?Ji(r,o)&&Ot(n,"set",i,r):Ot(n,"add",i,r)),l}}function Qp(t,e){const n=V(t,e);t[e];const i=Reflect.deleteProperty(t,e);return i&&n&&Ot(t,"delete",e,void 0),i}function Jp(t,e){const n=Reflect.has(t,e);return(!Ua(e)||!eh.has(e))&&Fe(t,"has",e),n}function Zp(t){return Fe(t,"iterate",N(t)?"length":vn),Reflect.ownKeys(t)}const nh={get:Vp,set:Yp,deleteProperty:Qp,has:Jp,ownKeys:Zp},eg={get:Gp,set(t,e){return!0},deleteProperty(t,e){return!0}},tg=pe({},nh,{get:zp,set:Xp}),Va=t=>t,Ds=t=>Reflect.getPrototypeOf(t);function Dr(t,e,n=!1,i=!1){t=t.__v_raw;const r=G(t),s=G(e);n||(e!==s&&Fe(r,"get",e),Fe(r,"get",s));const{has:o}=Ds(r),a=i?Va:n?Ka:Zi;if(o.call(r,e))return a(t.get(e));if(o.call(r,s))return a(t.get(s));t!==r&&t.get(e)}function Lr(t,e=!1){const n=this.__v_raw,i=G(n),r=G(t);return e||(t!==r&&Fe(i,"has",t),Fe(i,"has",r)),t===r?n.has(t):n.has(t)||n.has(r)}function $r(t,e=!1){return t=t.__v_raw,!e&&Fe(G(t),"iterate",vn),Reflect.get(t,"size",t)}function Bc(t){t=G(t);const e=G(this);return Ds(e).has.call(e,t)||(e.add(t),Ot(e,"add",t,t)),this}function Hc(t,e){e=G(e);const n=G(this),{has:i,get:r}=Ds(n);let s=i.call(n,t);s||(t=G(t),s=i.call(n,t));const o=r.call(n,t);return n.set(t,e),s?Ji(e,o)&&Ot(n,"set",t,e):Ot(n,"add",t,e),this}function jc(t){const e=G(this),{has:n,get:i}=Ds(e);let r=n.call(e,t);r||(t=G(t),r=n.call(e,t)),i&&i.call(e,t);const s=e.delete(t);return r&&Ot(e,"delete",t,void 0),s}function Wc(){const t=G(this),e=t.size!==0,n=t.clear();return e&&Ot(t,"clear",void 0,void 0),n}function Fr(t,e){return function(i,r){const s=this,o=s.__v_raw,a=G(o),l=e?Va:t?Ka:Zi;return!t&&Fe(a,"iterate",vn),o.forEach((c,u)=>i.call(r,l(c),l(u),s))}}function Ur(t,e,n){return function(...i){const r=this.__v_raw,s=G(r),o=Kn(s),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=r[t](...i),u=n?Va:e?Ka:Zi;return!e&&Fe(s,"iterate",l?Qo:vn),{next(){const{value:f,done:h}=c.next();return h?{value:f,done:h}:{value:a?[u(f[0]),u(f[1])]:u(f),done:h}},[Symbol.iterator](){return this}}}}function Nt(t){return function(...e){return t==="delete"?!1:this}}function ng(){const t={get(s){return Dr(this,s)},get size(){return $r(this)},has:Lr,add:Bc,set:Hc,delete:jc,clear:Wc,forEach:Fr(!1,!1)},e={get(s){return Dr(this,s,!1,!0)},get size(){return $r(this)},has:Lr,add:Bc,set:Hc,delete:jc,clear:Wc,forEach:Fr(!1,!0)},n={get(s){return Dr(this,s,!0)},get size(){return $r(this,!0)},has(s){return Lr.call(this,s,!0)},add:Nt("add"),set:Nt("set"),delete:Nt("delete"),clear:Nt("clear"),forEach:Fr(!0,!1)},i={get(s){return Dr(this,s,!0,!0)},get size(){return $r(this,!0)},has(s){return Lr.call(this,s,!0)},add:Nt("add"),set:Nt("set"),delete:Nt("delete"),clear:Nt("clear"),forEach:Fr(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Ur(s,!1,!1),n[s]=Ur(s,!0,!1),e[s]=Ur(s,!1,!0),i[s]=Ur(s,!0,!0)}),[t,n,e,i]}const[ig,rg,sg,og]=ng();function za(t,e){const n=e?t?og:sg:t?rg:ig;return(i,r,s)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?i:Reflect.get(V(n,r)&&r in i?n:i,r,s)}const ag={get:za(!1,!1)},lg={get:za(!1,!0)},cg={get:za(!0,!1)},ih=new WeakMap,rh=new WeakMap,sh=new WeakMap,ug=new WeakMap;function fg(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function hg(t){return t.__v_skip||!Object.isExtensible(t)?0:fg(Rp(t))}function Ga(t){return ri(t)?t:qa(t,!1,nh,ag,ih)}function dg(t){return qa(t,!1,tg,lg,rh)}function oh(t){return qa(t,!0,eg,cg,sh)}function qa(t,e,n,i,r){if(!oe(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=r.get(t);if(s)return s;const o=hg(t);if(o===0)return t;const a=new Proxy(t,o===2?i:n);return r.set(t,a),a}function Yn(t){return ri(t)?Yn(t.__v_raw):!!(t&&t.__v_isReactive)}function ri(t){return!!(t&&t.__v_isReadonly)}function rs(t){return!!(t&&t.__v_isShallow)}function ah(t){return Yn(t)||ri(t)}function G(t){const e=t&&t.__v_raw;return e?G(e):t}function lh(t){return is(t,"__v_skip",!0),t}const Zi=t=>oe(t)?Ga(t):t,Ka=t=>oe(t)?oh(t):t;function ch(t){Wt&&tt&&(t=G(t),Zf(t.dep||(t.dep=Ha())))}function uh(t,e){t=G(t);const n=t.dep;n&&Jo(n)}function Re(t){return!!(t&&t.__v_isRef===!0)}function nt(t){return _g(t,!1)}function _g(t,e){return Re(t)?t:new pg(t,e)}class pg{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:G(e),this._value=n?e:Zi(e)}get value(){return ch(this),this._value}set value(e){const n=this.__v_isShallow||rs(e)||ri(e);e=n?e:G(e),Ji(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Zi(e),uh(this))}}function er(t){return Re(t)?t.value:t}const gg={get:(t,e,n)=>er(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const r=t[e];return Re(r)&&!Re(n)?(r.value=n,!0):Reflect.set(t,e,n,i)}};function fh(t){return Yn(t)?t:new Proxy(t,gg)}class mg{constructor(e,n,i,r){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new ja(e,()=>{this._dirty||(this._dirty=!0,uh(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!r,this.__v_isReadonly=i}get value(){const e=G(this);return ch(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function vg(t,e,n=!1){let i,r;const s=F(t);return s?(i=t,r=ot):(i=t.get,r=t.set),new mg(i,r,s||!r,n)}function Vt(t,e,n,i){let r;try{r=i?t(...i):t()}catch(s){Ls(s,e,n)}return r}function Qe(t,e,n,i){if(F(t)){const s=Vt(t,e,n,i);return s&&Vf(s)&&s.catch(o=>{Ls(o,e,n)}),s}const r=[];for(let s=0;s<t.length;s++)r.push(Qe(t[s],e,n,i));return r}function Ls(t,e,n,i=!0){const r=e?e.vnode:null;if(e){let s=e.parent;const o=e.proxy,a=n;for(;s;){const c=s.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}s=s.parent}const l=e.appContext.config.errorHandler;if(l){Vt(l,null,10,[t,o,a]);return}}yg(t,n,r,i)}function yg(t,e,n,i=!0){console.error(t)}let tr=!1,Zo=!1;const Oe=[];let pt=0;const Xn=[];let bt=null,hn=0;const hh=Promise.resolve();let Ya=null;function Eg(t){const e=Ya||hh;return t?e.then(this?t.bind(this):t):e}function bg(t){let e=pt+1,n=Oe.length;for(;e<n;){const i=e+n>>>1;nr(Oe[i])<t?e=i+1:n=i}return e}function Xa(t){(!Oe.length||!Oe.includes(t,tr&&t.allowRecurse?pt+1:pt))&&(t.id==null?Oe.push(t):Oe.splice(bg(t.id),0,t),dh())}function dh(){!tr&&!Zo&&(Zo=!0,Ya=hh.then(ph))}function wg(t){const e=Oe.indexOf(t);e>pt&&Oe.splice(e,1)}function Ig(t){N(t)?Xn.push(...t):(!bt||!bt.includes(t,t.allowRecurse?hn+1:hn))&&Xn.push(t),dh()}function Vc(t,e=tr?pt+1:0){for(;e<Oe.length;e++){const n=Oe[e];n&&n.pre&&(Oe.splice(e,1),e--,n())}}function _h(t){if(Xn.length){const e=[...new Set(Xn)];if(Xn.length=0,bt){bt.push(...e);return}for(bt=e,bt.sort((n,i)=>nr(n)-nr(i)),hn=0;hn<bt.length;hn++)bt[hn]();bt=null,hn=0}}const nr=t=>t.id==null?1/0:t.id,Cg=(t,e)=>{const n=nr(t)-nr(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function ph(t){Zo=!1,tr=!0,Oe.sort(Cg);const e=ot;try{for(pt=0;pt<Oe.length;pt++){const n=Oe[pt];n&&n.active!==!1&&Vt(n,null,14)}}finally{pt=0,Oe.length=0,_h(),tr=!1,Ya=null,(Oe.length||Xn.length)&&ph()}}function Tg(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||se;let r=n;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in i){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:f,trim:h}=i[u]||se;h&&(r=n.map(p=>ge(p)?p.trim():p)),f&&(r=n.map(qo))}let a,l=i[a=mo(e)]||i[a=mo(ii(e))];!l&&s&&(l=i[a=mo(xn(e))]),l&&Qe(l,t,6,r);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Qe(c,t,6,r)}}function gh(t,e,n=!1){const i=e.emitsCache,r=i.get(t);if(r!==void 0)return r;const s=t.emits;let o={},a=!1;if(!F(t)){const l=c=>{const u=gh(c,e,!0);u&&(a=!0,pe(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!a?(oe(t)&&i.set(t,null),null):(N(s)?s.forEach(l=>o[l]=null):pe(o,s),oe(t)&&i.set(t,o),o)}function $s(t,e){return!t||!Ps(e)?!1:(e=e.slice(2).replace(/Once$/,""),V(t,e[0].toLowerCase()+e.slice(1))||V(t,xn(e))||V(t,e))}let Ye=null,Fs=null;function ss(t){const e=Ye;return Ye=t,Fs=t&&t.type.__scopeId||null,e}function mh(t){Fs=t}function vh(){Fs=null}function ea(t,e=Ye,n){if(!e||t._n)return t;const i=(...r)=>{i._d&&tu(-1);const s=ss(e);let o;try{o=t(...r)}finally{ss(s),i._d&&tu(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function vo(t){const{type:e,vnode:n,proxy:i,withProxy:r,props:s,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:f,data:h,setupState:p,ctx:E,inheritAttrs:b}=t;let P,W;const q=ss(t);try{if(n.shapeFlag&4){const k=r||i;P=_t(u.call(k,k,f,s,p,h,E)),W=l}else{const k=e;P=_t(k.length>1?k(s,{attrs:l,slots:a,emit:c}):k(s,null)),W=e.props?l:Sg(l)}}catch(k){Gi.length=0,Ls(k,t,1),P=ce(at)}let K=P;if(W&&b!==!1){const k=Object.keys(W),{shapeFlag:de}=K;k.length&&de&7&&(o&&k.some($a)&&(W=Og(W,o)),K=Qt(K,W))}return n.dirs&&(K=Qt(K),K.dirs=K.dirs?K.dirs.concat(n.dirs):n.dirs),n.transition&&(K.transition=n.transition),P=K,ss(q),P}const Sg=t=>{let e;for(const n in t)(n==="class"||n==="style"||Ps(n))&&((e||(e={}))[n]=t[n]);return e},Og=(t,e)=>{const n={};for(const i in t)(!$a(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function Rg(t,e,n){const{props:i,children:r,component:s}=t,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?zc(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const h=u[f];if(o[h]!==i[h]&&!$s(c,h))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?zc(i,o,c):!0:!!o;return!1}function zc(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==t[s]&&!$s(n,s))return!0}return!1}function Ag({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const xg=t=>t.__isSuspense;function kg(t,e){e&&e.pendingBranch?N(t)?e.effects.push(...t):e.effects.push(t):Ig(t)}const Br={};function yo(t,e,n){return yh(t,e,n)}function yh(t,e,{immediate:n,deep:i,flush:r,onTrack:s,onTrigger:o}=se){var a;const l=Bp()===((a=Ce)==null?void 0:a.scope)?Ce:null;let c,u=!1,f=!1;if(Re(t)?(c=()=>t.value,u=rs(t)):Yn(t)?(c=()=>t,i=!0):N(t)?(f=!0,u=t.some(k=>Yn(k)||rs(k)),c=()=>t.map(k=>{if(Re(k))return k.value;if(Yn(k))return pn(k);if(F(k))return Vt(k,l,2)})):F(t)?e?c=()=>Vt(t,l,2):c=()=>{if(!(l&&l.isUnmounted))return h&&h(),Qe(t,l,3,[p])}:c=ot,e&&i){const k=c;c=()=>pn(k())}let h,p=k=>{h=q.onStop=()=>{Vt(k,l,4)}},E;if(rr)if(p=ot,e?n&&Qe(e,l,3,[c(),f?[]:void 0,p]):c(),r==="sync"){const k=Rm();E=k.__watcherHandles||(k.__watcherHandles=[])}else return ot;let b=f?new Array(t.length).fill(Br):Br;const P=()=>{if(q.active)if(e){const k=q.run();(i||u||(f?k.some((de,Pe)=>Ji(de,b[Pe])):Ji(k,b)))&&(h&&h(),Qe(e,l,3,[k,b===Br?void 0:f&&b[0]===Br?[]:b,p]),b=k)}else q.run()};P.allowRecurse=!!e;let W;r==="sync"?W=P:r==="post"?W=()=>Ne(P,l&&l.suspense):(P.pre=!0,l&&(P.id=l.uid),W=()=>Xa(P));const q=new ja(c,W);e?n?P():b=q.run():r==="post"?Ne(q.run.bind(q),l&&l.suspense):q.run();const K=()=>{q.stop(),l&&l.scope&&Fa(l.scope.effects,q)};return E&&E.push(K),K}function Pg(t,e,n){const i=this.proxy,r=ge(t)?t.includes(".")?Eh(i,t):()=>i[t]:t.bind(i,i);let s;F(e)?s=e:(s=e.handler,n=e);const o=Ce;oi(this);const a=yh(r,s.bind(i),n);return o?oi(o):yn(),a}function Eh(t,e){const n=e.split(".");return()=>{let i=t;for(let r=0;r<n.length&&i;r++)i=i[n[r]];return i}}function pn(t,e){if(!oe(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Re(t))pn(t.value,e);else if(N(t))for(let n=0;n<t.length;n++)pn(t[n],e);else if(Wf(t)||Kn(t))t.forEach(n=>{pn(n,e)});else if(Gf(t))for(const n in t)pn(t[n],e);return t}function bh(t,e){const n=Ye;if(n===null)return t;const i=Vs(n)||n.proxy,r=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[o,a,l,c=se]=e[s];o&&(F(o)&&(o={mounted:o,updated:o}),o.deep&&pn(a),r.push({dir:o,instance:i,value:a,oldValue:void 0,arg:l,modifiers:c}))}return t}function on(t,e,n,i){const r=t.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(pi(),Qe(l,n,8,[t.el,a,t,e]),gi())}}function Ng(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return vr(()=>{t.isMounted=!0}),Hs(()=>{t.isUnmounting=!0}),t}const qe=[Function,Array],wh={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:qe,onEnter:qe,onAfterEnter:qe,onEnterCancelled:qe,onBeforeLeave:qe,onLeave:qe,onAfterLeave:qe,onLeaveCancelled:qe,onBeforeAppear:qe,onAppear:qe,onAfterAppear:qe,onAppearCancelled:qe},Mg={name:"BaseTransition",props:wh,setup(t,{slots:e}){const n=bm(),i=Ng();let r;return()=>{const s=e.default&&Ch(e.default(),!0);if(!s||!s.length)return;let o=s[0];if(s.length>1){for(const b of s)if(b.type!==at){o=b;break}}const a=G(t),{mode:l}=a;if(i.isLeaving)return Eo(o);const c=Gc(o);if(!c)return Eo(o);const u=ta(c,a,i,n);na(c,u);const f=n.subTree,h=f&&Gc(f);let p=!1;const{getTransitionKey:E}=c.type;if(E){const b=E();r===void 0?r=b:b!==r&&(r=b,p=!0)}if(h&&h.type!==at&&(!dn(c,h)||p)){const b=ta(h,a,i,n);if(na(h,b),l==="out-in")return i.isLeaving=!0,b.afterLeave=()=>{i.isLeaving=!1,n.update.active!==!1&&n.update()},Eo(o);l==="in-out"&&c.type!==at&&(b.delayLeave=(P,W,q)=>{const K=Ih(i,h);K[String(h.key)]=h,P._leaveCb=()=>{W(),P._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=q})}return o}}},Dg=Mg;function Ih(t,e){const{leavingVNodes:n}=t;let i=n.get(e.type);return i||(i=Object.create(null),n.set(e.type,i)),i}function ta(t,e,n,i){const{appear:r,mode:s,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:f,onLeave:h,onAfterLeave:p,onLeaveCancelled:E,onBeforeAppear:b,onAppear:P,onAfterAppear:W,onAppearCancelled:q}=e,K=String(t.key),k=Ih(n,t),de=($,ee)=>{$&&Qe($,i,9,ee)},Pe=($,ee)=>{const Z=ee[1];de($,ee),N($)?$.every(Se=>Se.length<=1)&&Z():$.length<=1&&Z()},Be={mode:s,persisted:o,beforeEnter($){let ee=a;if(!n.isMounted)if(r)ee=b||a;else return;$._leaveCb&&$._leaveCb(!0);const Z=k[K];Z&&dn(t,Z)&&Z.el._leaveCb&&Z.el._leaveCb(),de(ee,[$])},enter($){let ee=l,Z=c,Se=u;if(!n.isMounted)if(r)ee=P||l,Z=W||c,Se=q||u;else return;let R=!1;const le=$._enterCb=He=>{R||(R=!0,He?de(Se,[$]):de(Z,[$]),Be.delayedLeave&&Be.delayedLeave(),$._enterCb=void 0)};ee?Pe(ee,[$,le]):le()},leave($,ee){const Z=String(t.key);if($._enterCb&&$._enterCb(!0),n.isUnmounting)return ee();de(f,[$]);let Se=!1;const R=$._leaveCb=le=>{Se||(Se=!0,ee(),le?de(E,[$]):de(p,[$]),$._leaveCb=void 0,k[Z]===t&&delete k[Z])};k[Z]=t,h?Pe(h,[$,R]):R()},clone($){return ta($,e,n,i)}};return Be}function Eo(t){if(Us(t))return t=Qt(t),t.children=null,t}function Gc(t){return Us(t)?t.children?t.children[0]:void 0:t}function na(t,e){t.shapeFlag&6&&t.component?na(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Ch(t,e=!1,n){let i=[],r=0;for(let s=0;s<t.length;s++){let o=t[s];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:s);o.type===Ve?(o.patchFlag&128&&r++,i=i.concat(Ch(o.children,e,a))):(e||o.type!==at)&&i.push(a!=null?Qt(o,{key:a}):o)}if(r>1)for(let s=0;s<i.length;s++)i[s].patchFlag=-2;return i}function Lg(t,e){return F(t)?(()=>pe({name:t.name},e,{setup:t}))():t}const Xr=t=>!!t.type.__asyncLoader,Us=t=>t.type.__isKeepAlive;function $g(t,e){Th(t,"a",e)}function Fg(t,e){Th(t,"da",e)}function Th(t,e,n=Ce){const i=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return t()});if(Bs(e,i,n),n){let r=n.parent;for(;r&&r.parent;)Us(r.parent.vnode)&&Ug(i,e,n,r),r=r.parent}}function Ug(t,e,n,i){const r=Bs(e,t,i,!0);Sh(()=>{Fa(i[e],r)},n)}function Bs(t,e,n=Ce,i=!1){if(n){const r=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;pi(),oi(n);const a=Qe(e,n,t,o);return yn(),gi(),a});return i?r.unshift(s):r.push(s),s}}const kt=t=>(e,n=Ce)=>(!rr||t==="sp")&&Bs(t,(...i)=>e(...i),n),Bg=kt("bm"),vr=kt("m"),Hg=kt("bu"),jg=kt("u"),Hs=kt("bum"),Sh=kt("um"),Wg=kt("sp"),Vg=kt("rtg"),zg=kt("rtc");function Gg(t,e=Ce){Bs("ec",t,e)}const qg=Symbol.for("v-ndc");function Kg(t,e,n,i){let r;const s=n&&n[i];if(N(t)||ge(t)){r=new Array(t.length);for(let o=0,a=t.length;o<a;o++)r[o]=e(t[o],o,void 0,s&&s[o])}else if(typeof t=="number"){r=new Array(t);for(let o=0;o<t;o++)r[o]=e(o+1,o,void 0,s&&s[o])}else if(oe(t))if(t[Symbol.iterator])r=Array.from(t,(o,a)=>e(o,a,void 0,s&&s[a]));else{const o=Object.keys(t);r=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];r[a]=e(t[c],c,a,s&&s[a])}}else r=[];return n&&(n[i]=r),r}const ia=t=>t?$h(t)?Vs(t)||t.proxy:ia(t.parent):null,zi=pe(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>ia(t.parent),$root:t=>ia(t.root),$emit:t=>t.emit,$options:t=>Qa(t),$forceUpdate:t=>t.f||(t.f=()=>Xa(t.update)),$nextTick:t=>t.n||(t.n=Eg.bind(t.proxy)),$watch:t=>Pg.bind(t)}),bo=(t,e)=>t!==se&&!t.__isScriptSetup&&V(t,e),Yg={get({_:t},e){const{ctx:n,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return r[e];case 4:return n[e];case 3:return s[e]}else{if(bo(i,e))return o[e]=1,i[e];if(r!==se&&V(r,e))return o[e]=2,r[e];if((c=t.propsOptions[0])&&V(c,e))return o[e]=3,s[e];if(n!==se&&V(n,e))return o[e]=4,n[e];ra&&(o[e]=0)}}const u=zi[e];let f,h;if(u)return e==="$attrs"&&Fe(t,"get",e),u(t);if((f=a.__cssModules)&&(f=f[e]))return f;if(n!==se&&V(n,e))return o[e]=4,n[e];if(h=l.config.globalProperties,V(h,e))return h[e]},set({_:t},e,n){const{data:i,setupState:r,ctx:s}=t;return bo(r,e)?(r[e]=n,!0):i!==se&&V(i,e)?(i[e]=n,!0):V(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:r,propsOptions:s}},o){let a;return!!n[o]||t!==se&&V(t,o)||bo(e,o)||(a=s[0])&&V(a,o)||V(i,o)||V(zi,o)||V(r.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:V(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function qc(t){return N(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let ra=!0;function Xg(t){const e=Qa(t),n=t.proxy,i=t.ctx;ra=!1,e.beforeCreate&&Kc(e.beforeCreate,t,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:h,beforeUpdate:p,updated:E,activated:b,deactivated:P,beforeDestroy:W,beforeUnmount:q,destroyed:K,unmounted:k,render:de,renderTracked:Pe,renderTriggered:Be,errorCaptured:$,serverPrefetch:ee,expose:Z,inheritAttrs:Se,components:R,directives:le,filters:He}=e;if(c&&Qg(c,i,null),o)for(const ue in o){const te=o[ue];F(te)&&(i[ue]=te.bind(n))}if(r){const ue=r.call(n,n);oe(ue)&&(t.data=Ga(ue))}if(ra=!0,s)for(const ue in s){const te=s[ue],rn=F(te)?te.bind(n,n):F(te.get)?te.get.bind(n,n):ot,Nr=!F(te)&&F(te.set)?te.set.bind(n):ot,sn=Uh({get:rn,set:Nr});Object.defineProperty(i,ue,{enumerable:!0,configurable:!0,get:()=>sn.value,set:ft=>sn.value=ft})}if(a)for(const ue in a)Oh(a[ue],i,n,ue);if(l){const ue=F(l)?l.call(n):l;Reflect.ownKeys(ue).forEach(te=>{im(te,ue[te])})}u&&Kc(u,t,"c");function ve(ue,te){N(te)?te.forEach(rn=>ue(rn.bind(n))):te&&ue(te.bind(n))}if(ve(Bg,f),ve(vr,h),ve(Hg,p),ve(jg,E),ve($g,b),ve(Fg,P),ve(Gg,$),ve(zg,Pe),ve(Vg,Be),ve(Hs,q),ve(Sh,k),ve(Wg,ee),N(Z))if(Z.length){const ue=t.exposed||(t.exposed={});Z.forEach(te=>{Object.defineProperty(ue,te,{get:()=>n[te],set:rn=>n[te]=rn})})}else t.exposed||(t.exposed={});de&&t.render===ot&&(t.render=de),Se!=null&&(t.inheritAttrs=Se),R&&(t.components=R),le&&(t.directives=le)}function Qg(t,e,n=ot){N(t)&&(t=sa(t));for(const i in t){const r=t[i];let s;oe(r)?"default"in r?s=Qr(r.from||i,r.default,!0):s=Qr(r.from||i):s=Qr(r),Re(s)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[i]=s}}function Kc(t,e,n){Qe(N(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Oh(t,e,n,i){const r=i.includes(".")?Eh(n,i):()=>n[i];if(ge(t)){const s=e[t];F(s)&&yo(r,s)}else if(F(t))yo(r,t.bind(n));else if(oe(t))if(N(t))t.forEach(s=>Oh(s,e,n,i));else{const s=F(t.handler)?t.handler.bind(n):e[t.handler];F(s)&&yo(r,s,t)}}function Qa(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!n&&!i?l=e:(l={},r.length&&r.forEach(c=>os(l,c,o,!0)),os(l,e,o)),oe(e)&&s.set(e,l),l}function os(t,e,n,i=!1){const{mixins:r,extends:s}=e;s&&os(t,s,n,!0),r&&r.forEach(o=>os(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=Jg[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Jg={data:Yc,props:Xc,emits:Xc,methods:Hi,computed:Hi,beforeCreate:xe,created:xe,beforeMount:xe,mounted:xe,beforeUpdate:xe,updated:xe,beforeDestroy:xe,beforeUnmount:xe,destroyed:xe,unmounted:xe,activated:xe,deactivated:xe,errorCaptured:xe,serverPrefetch:xe,components:Hi,directives:Hi,watch:em,provide:Yc,inject:Zg};function Yc(t,e){return e?t?function(){return pe(F(t)?t.call(this,this):t,F(e)?e.call(this,this):e)}:e:t}function Zg(t,e){return Hi(sa(t),sa(e))}function sa(t){if(N(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function xe(t,e){return t?[...new Set([].concat(t,e))]:e}function Hi(t,e){return t?pe(Object.create(null),t,e):e}function Xc(t,e){return t?N(t)&&N(e)?[...new Set([...t,...e])]:pe(Object.create(null),qc(t),qc(e??{})):e}function em(t,e){if(!t)return e;if(!e)return t;const n=pe(Object.create(null),t);for(const i in e)n[i]=xe(t[i],e[i]);return n}function Rh(){return{app:null,config:{isNativeTag:Tp,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let tm=0;function nm(t,e){return function(i,r=null){F(i)||(i=pe({},i)),r!=null&&!oe(r)&&(r=null);const s=Rh(),o=new Set;let a=!1;const l=s.app={_uid:tm++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:Am,get config(){return s.config},set config(c){},use(c,...u){return o.has(c)||(c&&F(c.install)?(o.add(c),c.install(l,...u)):F(c)&&(o.add(c),c(l,...u))),l},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),l},component(c,u){return u?(s.components[c]=u,l):s.components[c]},directive(c,u){return u?(s.directives[c]=u,l):s.directives[c]},mount(c,u,f){if(!a){const h=ce(i,r);return h.appContext=s,u&&e?e(h,c):t(h,c,f),a=!0,l._container=c,c.__vue_app__=l,Vs(h.component)||h.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return s.provides[c]=u,l},runWithContext(c){as=l;try{return c()}finally{as=null}}};return l}}let as=null;function im(t,e){if(Ce){let n=Ce.provides;const i=Ce.parent&&Ce.parent.provides;i===n&&(n=Ce.provides=Object.create(i)),n[t]=e}}function Qr(t,e,n=!1){const i=Ce||Ye;if(i||as){const r=i?i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:as._context.provides;if(r&&t in r)return r[t];if(arguments.length>1)return n&&F(e)?e.call(i&&i.proxy):e}}function rm(t,e,n,i=!1){const r={},s={};is(s,Ws,1),t.propsDefaults=Object.create(null),Ah(t,e,r,s);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=i?r:dg(r):t.type.props?t.props=r:t.props=s,t.attrs=s}function sm(t,e,n,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=t,a=G(r),[l]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let f=0;f<u.length;f++){let h=u[f];if($s(t.emitsOptions,h))continue;const p=e[h];if(l)if(V(s,h))p!==s[h]&&(s[h]=p,c=!0);else{const E=ii(h);r[E]=oa(l,a,E,p,t,!1)}else p!==s[h]&&(s[h]=p,c=!0)}}}else{Ah(t,e,r,s)&&(c=!0);let u;for(const f in a)(!e||!V(e,f)&&((u=xn(f))===f||!V(e,u)))&&(l?n&&(n[f]!==void 0||n[u]!==void 0)&&(r[f]=oa(l,a,f,void 0,t,!0)):delete r[f]);if(s!==a)for(const f in s)(!e||!V(e,f))&&(delete s[f],c=!0)}c&&Ot(t,"set","$attrs")}function Ah(t,e,n,i){const[r,s]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Kr(l))continue;const c=e[l];let u;r&&V(r,u=ii(l))?!s||!s.includes(u)?n[u]=c:(a||(a={}))[u]=c:$s(t.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=G(n),c=a||se;for(let u=0;u<s.length;u++){const f=s[u];n[f]=oa(r,l,f,c[f],t,!V(c,f))}}return o}function oa(t,e,n,i,r,s){const o=t[n];if(o!=null){const a=V(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&F(l)){const{propsDefaults:c}=r;n in c?i=c[n]:(oi(r),i=c[n]=l.call(null,e),yn())}else i=l}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===xn(n))&&(i=!0))}return i}function xh(t,e,n=!1){const i=e.propsCache,r=i.get(t);if(r)return r;const s=t.props,o={},a=[];let l=!1;if(!F(t)){const u=f=>{l=!0;const[h,p]=xh(f,e,!0);pe(o,h),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!l)return oe(t)&&i.set(t,qn),qn;if(N(s))for(let u=0;u<s.length;u++){const f=ii(s[u]);Qc(f)&&(o[f]=se)}else if(s)for(const u in s){const f=ii(u);if(Qc(f)){const h=s[u],p=o[f]=N(h)||F(h)?{type:h}:pe({},h);if(p){const E=eu(Boolean,p.type),b=eu(String,p.type);p[0]=E>-1,p[1]=b<0||E<b,(E>-1||V(p,"default"))&&a.push(f)}}}const c=[o,a];return oe(t)&&i.set(t,c),c}function Qc(t){return t[0]!=="$"}function Jc(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function Zc(t,e){return Jc(t)===Jc(e)}function eu(t,e){return N(e)?e.findIndex(n=>Zc(n,t)):F(e)&&Zc(e,t)?0:-1}const kh=t=>t[0]==="_"||t==="$stable",Ja=t=>N(t)?t.map(_t):[_t(t)],om=(t,e,n)=>{if(e._n)return e;const i=ea((...r)=>Ja(e(...r)),n);return i._c=!1,i},Ph=(t,e,n)=>{const i=t._ctx;for(const r in t){if(kh(r))continue;const s=t[r];if(F(s))e[r]=om(r,s,i);else if(s!=null){const o=Ja(s);e[r]=()=>o}}},Nh=(t,e)=>{const n=Ja(e);t.slots.default=()=>n},am=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=G(e),is(e,"_",n)):Ph(e,t.slots={})}else t.slots={},e&&Nh(t,e);is(t.slots,Ws,1)},lm=(t,e,n)=>{const{vnode:i,slots:r}=t;let s=!0,o=se;if(i.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:(pe(r,e),!n&&a===1&&delete r._):(s=!e.$stable,Ph(e,r)),o=e}else e&&(Nh(t,e),o={default:1});if(s)for(const a in r)!kh(a)&&!(a in o)&&delete r[a]};function aa(t,e,n,i,r=!1){if(N(t)){t.forEach((h,p)=>aa(h,e&&(N(e)?e[p]:e),n,i,r));return}if(Xr(i)&&!r)return;const s=i.shapeFlag&4?Vs(i.component)||i.component.proxy:i.el,o=r?null:s,{i:a,r:l}=t,c=e&&e.r,u=a.refs===se?a.refs={}:a.refs,f=a.setupState;if(c!=null&&c!==l&&(ge(c)?(u[c]=null,V(f,c)&&(f[c]=null)):Re(c)&&(c.value=null)),F(l))Vt(l,a,12,[o,u]);else{const h=ge(l),p=Re(l);if(h||p){const E=()=>{if(t.f){const b=h?V(f,l)?f[l]:u[l]:l.value;r?N(b)&&Fa(b,s):N(b)?b.includes(s)||b.push(s):h?(u[l]=[s],V(f,l)&&(f[l]=u[l])):(l.value=[s],t.k&&(u[t.k]=l.value))}else h?(u[l]=o,V(f,l)&&(f[l]=o)):p&&(l.value=o,t.k&&(u[t.k]=o))};o?(E.id=-1,Ne(E,n)):E()}}}const Ne=kg;function cm(t){return um(t)}function um(t,e){const n=Ko();n.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:h,setScopeId:p=ot,insertStaticContent:E}=t,b=(d,_,g,v=null,m=null,C=null,S=!1,I=null,T=!!_.dynamicChildren)=>{if(d===_)return;d&&!dn(d,_)&&(v=Mr(d),ft(d,m,C,!0),d=null),_.patchFlag===-2&&(T=!1,_.dynamicChildren=null);const{type:y,ref:A,shapeFlag:O}=_;switch(y){case js:P(d,_,g,v);break;case at:W(d,_,g,v);break;case wo:d==null&&q(_,g,v,S);break;case Ve:R(d,_,g,v,m,C,S,I,T);break;default:O&1?de(d,_,g,v,m,C,S,I,T):O&6?le(d,_,g,v,m,C,S,I,T):(O&64||O&128)&&y.process(d,_,g,v,m,C,S,I,T,$n)}A!=null&&m&&aa(A,d&&d.ref,C,_||d,!_)},P=(d,_,g,v)=>{if(d==null)i(_.el=a(_.children),g,v);else{const m=_.el=d.el;_.children!==d.children&&c(m,_.children)}},W=(d,_,g,v)=>{d==null?i(_.el=l(_.children||""),g,v):_.el=d.el},q=(d,_,g,v)=>{[d.el,d.anchor]=E(d.children,_,g,v,d.el,d.anchor)},K=({el:d,anchor:_},g,v)=>{let m;for(;d&&d!==_;)m=h(d),i(d,g,v),d=m;i(_,g,v)},k=({el:d,anchor:_})=>{let g;for(;d&&d!==_;)g=h(d),r(d),d=g;r(_)},de=(d,_,g,v,m,C,S,I,T)=>{S=S||_.type==="svg",d==null?Pe(_,g,v,m,C,S,I,T):ee(d,_,m,C,S,I,T)},Pe=(d,_,g,v,m,C,S,I)=>{let T,y;const{type:A,props:O,shapeFlag:x,transition:L,dirs:j}=d;if(T=d.el=o(d.type,C,O&&O.is,O),x&8?u(T,d.children):x&16&&$(d.children,T,null,v,m,C&&A!=="foreignObject",S,I),j&&on(d,null,v,"created"),Be(T,d,d.scopeId,S,v),O){for(const X in O)X!=="value"&&!Kr(X)&&s(T,X,null,O[X],C,d.children,v,m,Et);"value"in O&&s(T,"value",null,O.value),(y=O.onVnodeBeforeMount)&&dt(y,v,d)}j&&on(d,null,v,"beforeMount");const ne=(!m||m&&!m.pendingBranch)&&L&&!L.persisted;ne&&L.beforeEnter(T),i(T,_,g),((y=O&&O.onVnodeMounted)||ne||j)&&Ne(()=>{y&&dt(y,v,d),ne&&L.enter(T),j&&on(d,null,v,"mounted")},m)},Be=(d,_,g,v,m)=>{if(g&&p(d,g),v)for(let C=0;C<v.length;C++)p(d,v[C]);if(m){let C=m.subTree;if(_===C){const S=m.vnode;Be(d,S,S.scopeId,S.slotScopeIds,m.parent)}}},$=(d,_,g,v,m,C,S,I,T=0)=>{for(let y=T;y<d.length;y++){const A=d[y]=I?$t(d[y]):_t(d[y]);b(null,A,_,g,v,m,C,S,I)}},ee=(d,_,g,v,m,C,S)=>{const I=_.el=d.el;let{patchFlag:T,dynamicChildren:y,dirs:A}=_;T|=d.patchFlag&16;const O=d.props||se,x=_.props||se;let L;g&&an(g,!1),(L=x.onVnodeBeforeUpdate)&&dt(L,g,_,d),A&&on(_,d,g,"beforeUpdate"),g&&an(g,!0);const j=m&&_.type!=="foreignObject";if(y?Z(d.dynamicChildren,y,I,g,v,j,C):S||te(d,_,I,null,g,v,j,C,!1),T>0){if(T&16)Se(I,_,O,x,g,v,m);else if(T&2&&O.class!==x.class&&s(I,"class",null,x.class,m),T&4&&s(I,"style",O.style,x.style,m),T&8){const ne=_.dynamicProps;for(let X=0;X<ne.length;X++){const _e=ne[X],Ze=O[_e],Fn=x[_e];(Fn!==Ze||_e==="value")&&s(I,_e,Ze,Fn,m,d.children,g,v,Et)}}T&1&&d.children!==_.children&&u(I,_.children)}else!S&&y==null&&Se(I,_,O,x,g,v,m);((L=x.onVnodeUpdated)||A)&&Ne(()=>{L&&dt(L,g,_,d),A&&on(_,d,g,"updated")},v)},Z=(d,_,g,v,m,C,S)=>{for(let I=0;I<_.length;I++){const T=d[I],y=_[I],A=T.el&&(T.type===Ve||!dn(T,y)||T.shapeFlag&70)?f(T.el):g;b(T,y,A,null,v,m,C,S,!0)}},Se=(d,_,g,v,m,C,S)=>{if(g!==v){if(g!==se)for(const I in g)!Kr(I)&&!(I in v)&&s(d,I,g[I],null,S,_.children,m,C,Et);for(const I in v){if(Kr(I))continue;const T=v[I],y=g[I];T!==y&&I!=="value"&&s(d,I,y,T,S,_.children,m,C,Et)}"value"in v&&s(d,"value",g.value,v.value)}},R=(d,_,g,v,m,C,S,I,T)=>{const y=_.el=d?d.el:a(""),A=_.anchor=d?d.anchor:a("");let{patchFlag:O,dynamicChildren:x,slotScopeIds:L}=_;L&&(I=I?I.concat(L):L),d==null?(i(y,g,v),i(A,g,v),$(_.children,g,A,m,C,S,I,T)):O>0&&O&64&&x&&d.dynamicChildren?(Z(d.dynamicChildren,x,g,m,C,S,I),(_.key!=null||m&&_===m.subTree)&&Mh(d,_,!0)):te(d,_,g,A,m,C,S,I,T)},le=(d,_,g,v,m,C,S,I,T)=>{_.slotScopeIds=I,d==null?_.shapeFlag&512?m.ctx.activate(_,g,v,S,T):He(_,g,v,m,C,S,T):Ai(d,_,T)},He=(d,_,g,v,m,C,S)=>{const I=d.component=Em(d,v,m);if(Us(d)&&(I.ctx.renderer=$n),wm(I),I.asyncDep){if(m&&m.registerDep(I,ve),!d.el){const T=I.subTree=ce(at);W(null,T,_,g)}return}ve(I,d,_,g,m,C,S)},Ai=(d,_,g)=>{const v=_.component=d.component;if(Rg(d,_,g))if(v.asyncDep&&!v.asyncResolved){ue(v,_,g);return}else v.next=_,wg(v.update),v.update();else _.el=d.el,v.vnode=_},ve=(d,_,g,v,m,C,S)=>{const I=()=>{if(d.isMounted){let{next:A,bu:O,u:x,parent:L,vnode:j}=d,ne=A,X;an(d,!1),A?(A.el=j.el,ue(d,A,S)):A=j,O&&Yr(O),(X=A.props&&A.props.onVnodeBeforeUpdate)&&dt(X,L,A,j),an(d,!0);const _e=vo(d),Ze=d.subTree;d.subTree=_e,b(Ze,_e,f(Ze.el),Mr(Ze),d,m,C),A.el=_e.el,ne===null&&Ag(d,_e.el),x&&Ne(x,m),(X=A.props&&A.props.onVnodeUpdated)&&Ne(()=>dt(X,L,A,j),m)}else{let A;const{el:O,props:x}=_,{bm:L,m:j,parent:ne}=d,X=Xr(_);if(an(d,!1),L&&Yr(L),!X&&(A=x&&x.onVnodeBeforeMount)&&dt(A,ne,_),an(d,!0),O&&go){const _e=()=>{d.subTree=vo(d),go(O,d.subTree,d,m,null)};X?_.type.__asyncLoader().then(()=>!d.isUnmounted&&_e()):_e()}else{const _e=d.subTree=vo(d);b(null,_e,g,v,d,m,C),_.el=_e.el}if(j&&Ne(j,m),!X&&(A=x&&x.onVnodeMounted)){const _e=_;Ne(()=>dt(A,ne,_e),m)}(_.shapeFlag&256||ne&&Xr(ne.vnode)&&ne.vnode.shapeFlag&256)&&d.a&&Ne(d.a,m),d.isMounted=!0,_=g=v=null}},T=d.effect=new ja(I,()=>Xa(y),d.scope),y=d.update=()=>T.run();y.id=d.uid,an(d,!0),y()},ue=(d,_,g)=>{_.component=d;const v=d.vnode.props;d.vnode=_,d.next=null,sm(d,_.props,v,g),lm(d,_.children,g),pi(),Vc(),gi()},te=(d,_,g,v,m,C,S,I,T=!1)=>{const y=d&&d.children,A=d?d.shapeFlag:0,O=_.children,{patchFlag:x,shapeFlag:L}=_;if(x>0){if(x&128){Nr(y,O,g,v,m,C,S,I,T);return}else if(x&256){rn(y,O,g,v,m,C,S,I,T);return}}L&8?(A&16&&Et(y,m,C),O!==y&&u(g,O)):A&16?L&16?Nr(y,O,g,v,m,C,S,I,T):Et(y,m,C,!0):(A&8&&u(g,""),L&16&&$(O,g,v,m,C,S,I,T))},rn=(d,_,g,v,m,C,S,I,T)=>{d=d||qn,_=_||qn;const y=d.length,A=_.length,O=Math.min(y,A);let x;for(x=0;x<O;x++){const L=_[x]=T?$t(_[x]):_t(_[x]);b(d[x],L,g,null,m,C,S,I,T)}y>A?Et(d,m,C,!0,!1,O):$(_,g,v,m,C,S,I,T,O)},Nr=(d,_,g,v,m,C,S,I,T)=>{let y=0;const A=_.length;let O=d.length-1,x=A-1;for(;y<=O&&y<=x;){const L=d[y],j=_[y]=T?$t(_[y]):_t(_[y]);if(dn(L,j))b(L,j,g,null,m,C,S,I,T);else break;y++}for(;y<=O&&y<=x;){const L=d[O],j=_[x]=T?$t(_[x]):_t(_[x]);if(dn(L,j))b(L,j,g,null,m,C,S,I,T);else break;O--,x--}if(y>O){if(y<=x){const L=x+1,j=L<A?_[L].el:v;for(;y<=x;)b(null,_[y]=T?$t(_[y]):_t(_[y]),g,j,m,C,S,I,T),y++}}else if(y>x)for(;y<=O;)ft(d[y],m,C,!0),y++;else{const L=y,j=y,ne=new Map;for(y=j;y<=x;y++){const je=_[y]=T?$t(_[y]):_t(_[y]);je.key!=null&&ne.set(je.key,y)}let X,_e=0;const Ze=x-j+1;let Fn=!1,Nc=0;const xi=new Array(Ze);for(y=0;y<Ze;y++)xi[y]=0;for(y=L;y<=O;y++){const je=d[y];if(_e>=Ze){ft(je,m,C,!0);continue}let ht;if(je.key!=null)ht=ne.get(je.key);else for(X=j;X<=x;X++)if(xi[X-j]===0&&dn(je,_[X])){ht=X;break}ht===void 0?ft(je,m,C,!0):(xi[ht-j]=y+1,ht>=Nc?Nc=ht:Fn=!0,b(je,_[ht],g,null,m,C,S,I,T),_e++)}const Mc=Fn?fm(xi):qn;for(X=Mc.length-1,y=Ze-1;y>=0;y--){const je=j+y,ht=_[je],Dc=je+1<A?_[je+1].el:v;xi[y]===0?b(null,ht,g,Dc,m,C,S,I,T):Fn&&(X<0||y!==Mc[X]?sn(ht,g,Dc,2):X--)}}},sn=(d,_,g,v,m=null)=>{const{el:C,type:S,transition:I,children:T,shapeFlag:y}=d;if(y&6){sn(d.component.subTree,_,g,v);return}if(y&128){d.suspense.move(_,g,v);return}if(y&64){S.move(d,_,g,$n);return}if(S===Ve){i(C,_,g);for(let O=0;O<T.length;O++)sn(T[O],_,g,v);i(d.anchor,_,g);return}if(S===wo){K(d,_,g);return}if(v!==2&&y&1&&I)if(v===0)I.beforeEnter(C),i(C,_,g),Ne(()=>I.enter(C),m);else{const{leave:O,delayLeave:x,afterLeave:L}=I,j=()=>i(C,_,g),ne=()=>{O(C,()=>{j(),L&&L()})};x?x(C,j,ne):ne()}else i(C,_,g)},ft=(d,_,g,v=!1,m=!1)=>{const{type:C,props:S,ref:I,children:T,dynamicChildren:y,shapeFlag:A,patchFlag:O,dirs:x}=d;if(I!=null&&aa(I,null,g,d,!0),A&256){_.ctx.deactivate(d);return}const L=A&1&&x,j=!Xr(d);let ne;if(j&&(ne=S&&S.onVnodeBeforeUnmount)&&dt(ne,_,d),A&6)Cp(d.component,g,v);else{if(A&128){d.suspense.unmount(g,v);return}L&&on(d,null,_,"beforeUnmount"),A&64?d.type.remove(d,_,g,m,$n,v):y&&(C!==Ve||O>0&&O&64)?Et(y,_,g,!1,!0):(C===Ve&&O&384||!m&&A&16)&&Et(T,_,g),v&&kc(d)}(j&&(ne=S&&S.onVnodeUnmounted)||L)&&Ne(()=>{ne&&dt(ne,_,d),L&&on(d,null,_,"unmounted")},g)},kc=d=>{const{type:_,el:g,anchor:v,transition:m}=d;if(_===Ve){Ip(g,v);return}if(_===wo){k(d);return}const C=()=>{r(g),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(d.shapeFlag&1&&m&&!m.persisted){const{leave:S,delayLeave:I}=m,T=()=>S(g,C);I?I(d.el,C,T):T()}else C()},Ip=(d,_)=>{let g;for(;d!==_;)g=h(d),r(d),d=g;r(_)},Cp=(d,_,g)=>{const{bum:v,scope:m,update:C,subTree:S,um:I}=d;v&&Yr(v),m.stop(),C&&(C.active=!1,ft(S,d,_,g)),I&&Ne(I,_),Ne(()=>{d.isUnmounted=!0},_),_&&_.pendingBranch&&!_.isUnmounted&&d.asyncDep&&!d.asyncResolved&&d.suspenseId===_.pendingId&&(_.deps--,_.deps===0&&_.resolve())},Et=(d,_,g,v=!1,m=!1,C=0)=>{for(let S=C;S<d.length;S++)ft(d[S],_,g,v,m)},Mr=d=>d.shapeFlag&6?Mr(d.component.subTree):d.shapeFlag&128?d.suspense.next():h(d.anchor||d.el),Pc=(d,_,g)=>{d==null?_._vnode&&ft(_._vnode,null,null,!0):b(_._vnode||null,d,_,null,null,null,g),Vc(),_h(),_._vnode=d},$n={p:b,um:ft,m:sn,r:kc,mt:He,mc:$,pc:te,pbc:Z,n:Mr,o:t};let po,go;return e&&([po,go]=e($n)),{render:Pc,hydrate:po,createApp:nm(Pc,po)}}function an({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Mh(t,e,n=!1){const i=t.children,r=e.children;if(N(i)&&N(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=$t(r[s]),a.el=o.el),n||Mh(o,a)),a.type===js&&(a.el=o.el)}}function fm(t){const e=t.slice(),n=[0];let i,r,s,o,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(r=n[n.length-1],t[r]<c){e[i]=r,n.push(i);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<c?s=a+1:o=a;c<t[n[s]]&&(s>0&&(e[i]=n[s-1]),n[s]=i)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}const hm=t=>t.__isTeleport,Ve=Symbol.for("v-fgt"),js=Symbol.for("v-txt"),at=Symbol.for("v-cmt"),wo=Symbol.for("v-stc"),Gi=[];let rt=null;function me(t=!1){Gi.push(rt=t?null:[])}function dm(){Gi.pop(),rt=Gi[Gi.length-1]||null}let ir=1;function tu(t){ir+=t}function Dh(t){return t.dynamicChildren=ir>0?rt||qn:null,dm(),ir>0&&rt&&rt.push(t),t}function Ge(t,e,n,i,r,s){return Dh(z(t,e,n,i,r,s,!0))}function si(t,e,n,i,r){return Dh(ce(t,e,n,i,r,!0))}function la(t){return t?t.__v_isVNode===!0:!1}function dn(t,e){return t.type===e.type&&t.key===e.key}const Ws="__vInternal",Lh=({key:t})=>t??null,Jr=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?ge(t)||Re(t)||F(t)?{i:Ye,r:t,k:e,f:!!n}:t:null);function z(t,e=null,n=null,i=0,r=null,s=t===Ve?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Lh(e),ref:e&&Jr(e),scopeId:Fs,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Ye};return a?(Za(l,n),s&128&&t.normalize(l)):n&&(l.shapeFlag|=ge(n)?8:16),ir>0&&!o&&rt&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&rt.push(l),l}const ce=_m;function _m(t,e=null,n=null,i=0,r=null,s=!1){if((!t||t===qg)&&(t=at),la(t)){const a=Qt(t,e,!0);return n&&Za(a,n),ir>0&&!s&&rt&&(a.shapeFlag&6?rt[rt.indexOf(t)]=a:rt.push(a)),a.patchFlag|=-2,a}if(Sm(t)&&(t=t.__vccOpts),e){e=pm(e);let{class:a,style:l}=e;a&&!ge(a)&&(e.class=ke(a)),oe(l)&&(ah(l)&&!N(l)&&(l=pe({},l)),e.style=kn(l))}const o=ge(t)?1:xg(t)?128:hm(t)?64:oe(t)?4:F(t)?2:0;return z(t,e,n,i,r,o,s,!0)}function pm(t){return t?ah(t)||Ws in t?pe({},t):t:null}function Qt(t,e,n=!1){const{props:i,ref:r,patchFlag:s,children:o}=t,a=e?mm(i||{},e):i;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Lh(a),ref:e&&e.ref?n&&r?N(r)?r.concat(Jr(e)):[r,Jr(e)]:Jr(e):r,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Ve?s===-1?16:s|16:s,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Qt(t.ssContent),ssFallback:t.ssFallback&&Qt(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function gm(t=" ",e=0){return ce(js,null,t,e)}function ca(t="",e=!1){return e?(me(),si(at,null,t)):ce(at,null,t)}function _t(t){return t==null||typeof t=="boolean"?ce(at):N(t)?ce(Ve,null,t.slice()):typeof t=="object"?$t(t):ce(js,null,String(t))}function $t(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Qt(t)}function Za(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(N(e))n=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),Za(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!(Ws in e)?e._ctx=Ye:r===3&&Ye&&(Ye.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else F(e)?(e={default:e,_ctx:Ye},n=32):(e=String(e),i&64?(n=16,e=[gm(e)]):n=8);t.children=e,t.shapeFlag|=n}function mm(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=ke([e.class,i.class]));else if(r==="style")e.style=kn([e.style,i.style]);else if(Ps(r)){const s=e[r],o=i[r];o&&s!==o&&!(N(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function dt(t,e,n,i=null){Qe(t,e,7,[n,i])}const vm=Rh();let ym=0;function Em(t,e,n){const i=t.type,r=(e?e.appContext:t.appContext)||vm,s={uid:ym++,vnode:t,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,scope:new Fp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:xh(i,r),emitsOptions:gh(i,r),emit:null,emitted:null,propsDefaults:se,inheritAttrs:i.inheritAttrs,ctx:se,data:se,props:se,attrs:se,slots:se,refs:se,setupState:se,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=Tg.bind(null,s),t.ce&&t.ce(s),s}let Ce=null;const bm=()=>Ce||Ye;let el,Un,nu="__VUE_INSTANCE_SETTERS__";(Un=Ko()[nu])||(Un=Ko()[nu]=[]),Un.push(t=>Ce=t),el=t=>{Un.length>1?Un.forEach(e=>e(t)):Un[0](t)};const oi=t=>{el(t),t.scope.on()},yn=()=>{Ce&&Ce.scope.off(),el(null)};function $h(t){return t.vnode.shapeFlag&4}let rr=!1;function wm(t,e=!1){rr=e;const{props:n,children:i}=t.vnode,r=$h(t);rm(t,n,r,e),am(t,i);const s=r?Im(t,e):void 0;return rr=!1,s}function Im(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=lh(new Proxy(t.ctx,Yg));const{setup:i}=n;if(i){const r=t.setupContext=i.length>1?Tm(t):null;oi(t),pi();const s=Vt(i,t,0,[t.props,r]);if(gi(),yn(),Vf(s)){if(s.then(yn,yn),e)return s.then(o=>{iu(t,o,e)}).catch(o=>{Ls(o,t,0)});t.asyncDep=s}else iu(t,s,e)}else Fh(t,e)}function iu(t,e,n){F(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:oe(e)&&(t.setupState=fh(e)),Fh(t,n)}let ru;function Fh(t,e,n){const i=t.type;if(!t.render){if(!e&&ru&&!i.render){const r=i.template||Qa(t).template;if(r){const{isCustomElement:s,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=i,c=pe(pe({isCustomElement:s,delimiters:a},o),l);i.render=ru(r,c)}}t.render=i.render||ot}oi(t),pi(),Xg(t),gi(),yn()}function Cm(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return Fe(t,"get","$attrs"),e[n]}}))}function Tm(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return Cm(t)},slots:t.slots,emit:t.emit,expose:e}}function Vs(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(fh(lh(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in zi)return zi[n](t)},has(e,n){return n in e||n in zi}}))}function Sm(t){return F(t)&&"__vccOpts"in t}const Uh=(t,e)=>vg(t,e,rr);function Bh(t,e,n){const i=arguments.length;return i===2?oe(e)&&!N(e)?la(e)?ce(t,null,[e]):ce(t,e):ce(t,null,e):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&la(n)&&(n=[n]),ce(t,e,n))}const Om=Symbol.for("v-scx"),Rm=()=>Qr(Om),Am="3.3.4",xm="http://www.w3.org/2000/svg",_n=typeof document<"u"?document:null,su=_n&&_n.createElement("template"),km={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const r=e?_n.createElementNS(xm,t):_n.createElement(t,n?{is:n}:void 0);return t==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:t=>_n.createTextNode(t),createComment:t=>_n.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>_n.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,r,s){const o=n?n.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),n),!(r===s||!(r=r.nextSibling)););else{su.innerHTML=i?`<svg>${t}</svg>`:t;const a=su.content;if(i){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Pm(t,e,n){const i=t._vtc;i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function Nm(t,e,n){const i=t.style,r=ge(n);if(n&&!r){if(e&&!ge(e))for(const s in e)n[s]==null&&ua(i,s,"");for(const s in n)ua(i,s,n[s])}else{const s=i.display;r?e!==n&&(i.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(i.display=s)}}const ou=/\s*!important$/;function ua(t,e,n){if(N(n))n.forEach(i=>ua(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=Mm(t,e);ou.test(n)?t.setProperty(xn(i),n.replace(ou,""),"important"):t[i]=n}}const au=["Webkit","Moz","ms"],Io={};function Mm(t,e){const n=Io[e];if(n)return n;let i=ii(e);if(i!=="filter"&&i in t)return Io[e]=i;i=qf(i);for(let r=0;r<au.length;r++){const s=au[r]+i;if(s in t)return Io[e]=s}return e}const lu="http://www.w3.org/1999/xlink";function Dm(t,e,n,i,r){if(i&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(lu,e.slice(6,e.length)):t.setAttributeNS(lu,e,n);else{const s=$p(e);n==null||s&&!Kf(n)?t.removeAttribute(e):t.setAttribute(e,s?"":n)}}function Lm(t,e,n,i,r,s,o){if(e==="innerHTML"||e==="textContent"){i&&o(i,r,s),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const c=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";c!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let l=!1;if(n===""||n==null){const c=typeof t[e];c==="boolean"?n=Kf(n):n==null&&c==="string"?(n="",l=!0):c==="number"&&(n=0,l=!0)}try{t[e]=n}catch{}l&&t.removeAttribute(e)}function Vn(t,e,n,i){t.addEventListener(e,n,i)}function $m(t,e,n,i){t.removeEventListener(e,n,i)}function Fm(t,e,n,i,r=null){const s=t._vei||(t._vei={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=Um(e);if(i){const c=s[e]=jm(i,r);Vn(t,a,c,l)}else o&&($m(t,a,o,l),s[e]=void 0)}}const cu=/(?:Once|Passive|Capture)$/;function Um(t){let e;if(cu.test(t)){e={};let i;for(;i=t.match(cu);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):xn(t.slice(2)),e]}let Co=0;const Bm=Promise.resolve(),Hm=()=>Co||(Bm.then(()=>Co=0),Co=Date.now());function jm(t,e){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;Qe(Wm(i,n.value),e,5,[i])};return n.value=t,n.attached=Hm(),n}function Wm(t,e){if(N(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const uu=/^on[a-z]/,Vm=(t,e,n,i,r=!1,s,o,a,l)=>{e==="class"?Pm(t,i,r):e==="style"?Nm(t,n,i):Ps(e)?$a(e)||Fm(t,e,n,i,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):zm(t,e,i,r))?Lm(t,e,i,s,o,a,l):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),Dm(t,e,i,r))};function zm(t,e,n,i){return i?!!(e==="innerHTML"||e==="textContent"||e in t&&uu.test(e)&&F(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||uu.test(e)&&ge(n)?!1:e in t}const Mt="transition",ki="animation",ls=(t,{slots:e})=>Bh(Dg,Gm(t),e);ls.displayName="Transition";const Hh={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};ls.props=pe({},wh,Hh);const ln=(t,e=[])=>{N(t)?t.forEach(n=>n(...e)):t&&t(...e)},fu=t=>t?N(t)?t.some(e=>e.length>1):t.length>1:!1;function Gm(t){const e={};for(const R in t)R in Hh||(e[R]=t[R]);if(t.css===!1)return e;const{name:n="v",type:i,duration:r,enterFromClass:s=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:l=s,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:f=`${n}-leave-from`,leaveActiveClass:h=`${n}-leave-active`,leaveToClass:p=`${n}-leave-to`}=t,E=qm(r),b=E&&E[0],P=E&&E[1],{onBeforeEnter:W,onEnter:q,onEnterCancelled:K,onLeave:k,onLeaveCancelled:de,onBeforeAppear:Pe=W,onAppear:Be=q,onAppearCancelled:$=K}=e,ee=(R,le,He)=>{cn(R,le?u:a),cn(R,le?c:o),He&&He()},Z=(R,le)=>{R._isLeaving=!1,cn(R,f),cn(R,p),cn(R,h),le&&le()},Se=R=>(le,He)=>{const Ai=R?Be:q,ve=()=>ee(le,R,He);ln(Ai,[le,ve]),hu(()=>{cn(le,R?l:s),Dt(le,R?u:a),fu(Ai)||du(le,i,b,ve)})};return pe(e,{onBeforeEnter(R){ln(W,[R]),Dt(R,s),Dt(R,o)},onBeforeAppear(R){ln(Pe,[R]),Dt(R,l),Dt(R,c)},onEnter:Se(!1),onAppear:Se(!0),onLeave(R,le){R._isLeaving=!0;const He=()=>Z(R,le);Dt(R,f),Xm(),Dt(R,h),hu(()=>{R._isLeaving&&(cn(R,f),Dt(R,p),fu(k)||du(R,i,P,He))}),ln(k,[R,He])},onEnterCancelled(R){ee(R,!1),ln(K,[R])},onAppearCancelled(R){ee(R,!0),ln($,[R])},onLeaveCancelled(R){Z(R),ln(de,[R])}})}function qm(t){if(t==null)return null;if(oe(t))return[To(t.enter),To(t.leave)];{const e=To(t);return[e,e]}}function To(t){return kp(t)}function Dt(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function cn(t,e){e.split(/\s+/).forEach(i=>i&&t.classList.remove(i));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function hu(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let Km=0;function du(t,e,n,i){const r=t._endId=++Km,s=()=>{r===t._endId&&i()};if(n)return setTimeout(s,n);const{type:o,timeout:a,propCount:l}=Ym(t,e);if(!o)return i();const c=o+"end";let u=0;const f=()=>{t.removeEventListener(c,h),s()},h=p=>{p.target===t&&++u>=l&&f()};setTimeout(()=>{u<l&&f()},a+1),t.addEventListener(c,h)}function Ym(t,e){const n=window.getComputedStyle(t),i=E=>(n[E]||"").split(", "),r=i(`${Mt}Delay`),s=i(`${Mt}Duration`),o=_u(r,s),a=i(`${ki}Delay`),l=i(`${ki}Duration`),c=_u(a,l);let u=null,f=0,h=0;e===Mt?o>0&&(u=Mt,f=o,h=s.length):e===ki?c>0&&(u=ki,f=c,h=l.length):(f=Math.max(o,c),u=f>0?o>c?Mt:ki:null,h=u?u===Mt?s.length:l.length:0);const p=u===Mt&&/\b(transform|all)(,|$)/.test(i(`${Mt}Property`).toString());return{type:u,timeout:f,propCount:h,hasTransform:p}}function _u(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,i)=>pu(n)+pu(t[i])))}function pu(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function Xm(){return document.body.offsetHeight}const gu=t=>{const e=t.props["onUpdate:modelValue"]||!1;return N(e)?n=>Yr(e,n):e};function Qm(t){t.target.composing=!0}function mu(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Jm={created(t,{modifiers:{lazy:e,trim:n,number:i}},r){t._assign=gu(r);const s=i||r.props&&r.props.type==="number";Vn(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),s&&(a=qo(a)),t._assign(a)}),n&&Vn(t,"change",()=>{t.value=t.value.trim()}),e||(Vn(t,"compositionstart",Qm),Vn(t,"compositionend",mu),Vn(t,"change",mu))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:i,number:r}},s){if(t._assign=gu(s),t.composing||document.activeElement===t&&t.type!=="range"&&(n||i&&t.value.trim()===e||(r||t.type==="number")&&qo(t.value)===e))return;const o=e??"";t.value!==o&&(t.value=o)}},Zm={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},ev=(t,e)=>n=>{if(!("key"in n))return;const i=xn(n.key);if(e.some(r=>r===i||Zm[r]===i))return t(n)},tv={beforeMount(t,{value:e},{transition:n}){t._vod=t.style.display==="none"?"":t.style.display,n&&e?n.beforeEnter(t):Pi(t,e)},mounted(t,{value:e},{transition:n}){n&&e&&n.enter(t)},updated(t,{value:e,oldValue:n},{transition:i}){!e!=!n&&(i?e?(i.beforeEnter(t),Pi(t,!0),i.enter(t)):i.leave(t,()=>{Pi(t,!1)}):Pi(t,e))},beforeUnmount(t,{value:e}){Pi(t,e)}};function Pi(t,e){t.style.display=e?t._vod:"none"}const nv=pe({patchProp:Vm},km);let vu;function iv(){return vu||(vu=cm(nv))}const rv=(...t)=>{const e=iv().createApp(...t),{mount:n}=e;return e.mount=i=>{const r=sv(i);if(!r)return;const s=e._component;!F(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.innerHTML="";const o=n(r,!1,r instanceof SVGElement);return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function sv(t){return ge(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const w=function(t,e){if(!t)throw mi(e)},mi=function(t){return new Error("Firebase Database ("+jh.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lv(t){return zh(void 0,t)}function zh(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!cv(n)||(t[n]=zh(t[n],e[n]));return t}function cv(t){return t!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function il(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Ae())}function gv(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Yh(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function mv(){const t=Ae();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Xh(){return jh.NODE_ADMIN===!0}function vv(){try{return typeof indexedDB=="object"}catch{return!1}}function yv(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",r=self.indexedDB.open(i);r.onsuccess=()=>{r.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},r.onupgradeneeded=()=>{n=!1},r.onerror=()=>{var s;e(((s=r.error)===null||s===void 0?void 0:s.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qh=function(t){let e={},n={},i={},r="";try{const s=t.split(".");e=sr(us(s[0])||""),n=sr(us(s[1])||""),r=s[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:r}},Iv=function(t){const e=Qh(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},Cv=function(t){const e=Qh(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yi=b0;function ed(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i=Object.assign({name:pa,automaticDataCollectionEnabled:!1},e),r=i.name;if(typeof r!="string"||!r)throw Gt.create("bad-app-name",{appName:String(r)});if(n||(n=qh()),!n)throw Gt.create("no-options");const s=ds.get(r);if(s){if(hs(n,s.options)&&hs(i,s.config))return s;throw Gt.create("duplicate-app",{appName:r})}const o=new Nv(r);for(const l of ga.values())o.addComponent(l);const a=new T0(n,i,o);return ds.set(r,a),a}function td(t=pa){const e=ds.get(t);if(!e&&t===pa&&qh())return ed();if(!e)throw Gt.create("no-app",{appName:t});return e}function qt(t,e,n){var i;let r=(i=w0[t])!==null&&i!==void 0?i:t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Cn.warn(a.join(" "));return}li(new In(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S0="firebase-heartbeat-database",O0=1,or="firebase-heartbeat-store";let xo=null;function nd(){return xo||(xo=Gv(S0,O0,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(or)}}}).catch(t=>{throw Gt.create("idb-open",{originalErrorMessage:t.message})})),xo}async function R0(t){try{return await(await nd()).transaction(or).objectStore(or).get(id(t))}catch(e){if(e instanceof en)Cn.warn(e.message);else{const n=Gt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Cn.warn(n.message)}}}async function Cu(t,e){try{const i=(await nd()).transaction(or,"readwrite");await i.objectStore(or).put(e,id(t)),await i.done}catch(n){if(n instanceof en)Cn.warn(n.message);else{const i=Gt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Cn.warn(i.message)}}}function id(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M0(t){li(new In("platform-logger",e=>new Yv(e),"PRIVATE")),li(new In("heartbeat",e=>new k0(e),"PRIVATE")),qt(_a,Iu,t),qt(_a,Iu,"esm2017"),qt("fire-js","")}M0("");function ll(t,e){var n={};for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&e.indexOf(i)<0&&(n[i]=t[i]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var r=0,i=Object.getOwnPropertySymbols(t);r<i.length;r++)e.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(t,i[r])&&(n[i[r]]=t[i[r]]);return n}function rd(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const D0=rd,sd=new yr("auth","Firebase",rd());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ct(t,...e){throw cl(t,...e)}function mt(t,...e){return cl(t,...e)}function $0(t,e,n){const i=Object.assign(Object.assign({},D0()),{[e]:n});return new yr("auth","Firebase",i).create(e,{appName:t.name})}function cl(t,...e){if(typeof t!="string"){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return sd.create(t,...e)}function D(t,e,...n){if(!t)throw cl(e,...n)}function wt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Zr(e),new Error(e)}function Rt(t,e){t||wt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ma(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function F0(){return Ou()==="http:"||Ou()==="https:"}function Ou(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U0(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(F0()||gv()||"connection"in navigator)?navigator.onLine:!0}function B0(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(e,n){this.shortDelay=e,this.longDelay=n,Rt(n>e,"Short delay should be less than long delay!"),this.isMobile=il()||Yh()}get(){return U0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Z0(t,e){const n=await ad(t,{},async()=>{const i=vi({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=t.config,o=ld(t,r,"/v1/token",`key=${s}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",od.fetch()(o,{method:"POST",headers:a,body:i})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ud{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}ud.type="NONE";const Au=ud;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xu(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(dd(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(fd(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(pd(e))return"Blackberry";if(gd(e))return"Webos";if(hl(e))return"Safari";if((e.includes("chrome/")||hd(e))&&!e.includes("edge/"))return"Chrome";if(_d(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=t.match(n);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function fd(t=Ae()){return/firefox\//i.test(t)}function hl(t=Ae()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function hd(t=Ae()){return/crios\//i.test(t)}function dd(t=Ae()){return/iemobile/i.test(t)}function _d(t=Ae()){return/android/i.test(t)}function pd(t=Ae()){return/blackberry/i.test(t)}function gd(t=Ae()){return/webos/i.test(t)}function Ks(t=Ae()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function ey(t=Ae()){var e;return Ks(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ty(){return mv()&&document.documentMode===10}function md(t=Ae()){return Ks(t)||_d(t)||gd(t)||pd(t)||/windows phone/i.test(t)||dd(t)}function ny(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vd(t,e=[]){let n;switch(t){case"Browser":n=xu(Ae());break;case"Worker":n=`${xu(Ae())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${yi}/${i}`}async function yd(t,e){return Ei(t,"GET","/v2/recaptchaConfig",br(t,e))}function ku(t){return t!==void 0&&t.enterprise!==void 0}class Ed{constructor(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(n=>n.provider==="EMAIL_PASSWORD_PROVIDER"&&n.enforcementState!=="OFF")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ir extends Cd{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ft extends Ir{constructor(){super("facebook.com")}static credential(e){return Tn._fromParams({providerId:Ft.PROVIDER_ID,signInMethod:Ft.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ft.credentialFromTaggedObject(e)}static credentialFromError(e){return Ft.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ft.credential(e.oauthAccessToken)}catch{return null}}}Ft.FACEBOOK_SIGN_IN_METHOD="facebook.com";Ft.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Od{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(ms,"1"),this.storage.removeItem(ms),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ad extends Od{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}Ad.type="SESSION";const xd=Ad;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kd(){return typeof vt().WorkerGlobalScope<"u"&&typeof vt().importScripts=="function"}async function My(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Dy(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function Ly(){return kd()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dd{constructor(e,n,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:i,postBody:r,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Vy;case"linkViaPopup":case"linkViaRedirect":return Gy;case"reauthViaPopup":case"reauthViaRedirect":return zy;default:ct(this.auth,"internal-error")}}resolve(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Rt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tE=10*60*1e3;class nE{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(n=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!iE(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var i;if(e.error&&!Ld(e)){const r=((i=e.error.code)===null||i===void 0?void 0:i.split("auth/")[1])||"internal-error";n.onError(mt(this.auth,r))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const i=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=tE&&this.cachedEventUids.clear(),this.cachedEventUids.has(Fu(e))}saveEventToCache(e){this.cachedEventUids.add(Fu(e)),this.lastProcessedEventTime=Date.now()}}function Fu(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function Ld({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function iE(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return Ld(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const f_=function(t){try{if(typeof window<"u"&&typeof window[t]<"u"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new jT(e)}}catch{}return new WT},gn=f_("localStorage"),wa=f_("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nS{constructor(e,n){this.appName_=e,this.appCheckProvider=n,this.appCheck=n==null?void 0:n.getImmediate({optional:!0}),this.appCheck||n==null||n.get().then(i=>this.appCheck=i)}getToken(e){return this.appCheck?this.appCheck.getToken(e):new Promise((n,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(n,i):n(null)},0)})}addTokenChangeListener(e){var n;(n=this.appCheckProvider)===null||n===void 0||n.get().then(i=>i.addTokenListener(e))}notifyForInvalidToken(){$e(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xl="5",p_="v",g_="s",m_="r",v_="f",y_=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,E_="ls",b_="p",Ca="ac",w_="websocket",I_="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hf="start",lS="close",cS="pLPCommand",uS="pRTLPCB",S_="id",O_="pw",R_="ser",fS="cb",hS="seg",dS="ts",_S="d",pS="dframe",A_=1870,x_=30,gS=A_-x_,mS=25e3,vS=3e4;class Gn{constructor(e,n,i,r,s,o,a){this.connId=e,this.repoInfo=n,this.applicationId=i,this.appCheckToken=r,this.authToken=s,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=xr(e),this.stats_=Ql(n),this.urlFn=l=>(this.appCheckToken&&(l[Ca]=this.appCheckToken),T_(n,I_,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new aS(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(vS)),qT(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Jl((...s)=>{const[o,a,l,c,u]=s;if(this.incrementIncomingBytes_(s),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===hf)this.id=a,this.password=l;else if(o===lS)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...s)=>{const[o,a]=s;this.incrementIncomingBytes_(s),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const i={};i[hf]="t",i[R_]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[fS]=this.scriptTagHolder.uniqueCallbackIdentifier),i[p_]=Xl,this.transportSessionId&&(i[g_]=this.transportSessionId),this.lastSessionId&&(i[E_]=this.lastSessionId),this.applicationId&&(i[b_]=this.applicationId),this.appCheckToken&&(i[Ca]=this.appCheckToken),typeof location<"u"&&location.hostname&&y_.test(location.hostname)&&(i[m_]=v_);const r=this.urlFn(i);this.log_("Connecting via long-poll to "+r),this.scriptTagHolder.addTag(r,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){Gn.forceAllow_=!0}static forceDisallow(){Gn.forceDisallow_=!0}static isAvailable(){return Gn.forceAllow_?!0:!Gn.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!YT()&&!XT()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=be(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const i=Vh(n),r=d_(i,gS);for(let s=0;s<r.length;s++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,r.length,r[s]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const i={};i[pS]="t",i[S_]=e,i[O_]=n,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=be(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class Jl{constructor(e,n,i,r){this.onDisconnect=i,this.urlFn=r,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=VT(),window[cS+this.uniqueCallbackIdentifier]=e,window[uS+this.uniqueCallbackIdentifier]=n,this.myIFrame=Jl.createIFrame_();let s="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(s='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+s+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){we("frame writing exception"),a.stack&&we(a.stack),we(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||we("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[S_]=this.myID,e[O_]=this.myPW,e[R_]=this.currentSerial;let n=this.urlFn(e),i="",r=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+x_+i.length<=A_;){const o=this.pendingSegs.shift();i=i+"&"+hS+r+"="+o.seg+"&"+dS+r+"="+o.ts+"&"+_S+r+"="+o.d,r++}return n=n+i,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,i){this.pendingSegs.push({seg:e,ts:n,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const i=()=>{this.outstandingRequests.delete(n),this.newRequest_()},r=setTimeout(i,Math.floor(mS)),s=()=>{clearTimeout(r),i()};this.addTag(e,s)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const r=i.readyState;(!r||r==="loaded"||r==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),n())},i.onerror=()=>{we("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class k_{put(e,n,i,r){}merge(e,n,i,r){}refreshAuthToken(e){}refreshAppCheckToken(e){}onDisconnectPut(e,n,i){}onDisconnectMerge(e,n,i){}onDisconnectCancel(e,n){}reportStats(e){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class P_{constructor(e){this.allowedEvents_=e,this.listeners_={},w(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const i=[...this.listeners_[e]];for(let r=0;r<i.length;r++)i[r].callback.apply(i[r].context,n)}}on(e,n,i){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:i});const r=this.getInitialEvent(e);r&&n.apply(i,r)}off(e,n,i){this.validateEventType_(e);const r=this.listeners_[e]||[];for(let s=0;s<r.length;s++)if(r[s].callback===n&&(!i||i===r[s].context)){r.splice(s,1);return}}validateEventType_(e){w(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Es extends P_{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!il()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Es}getInitialEvent(e){return w(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc extends P_{constructor(){super(["visible"]);let e,n;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(n="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(n="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(n="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(n="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,n&&document.addEventListener(n,()=>{const i=!document[e];i!==this.visible_&&(this.visible_=i,this.trigger("visible",i))},!1)}static getInstance(){return new tc}getInitialEvent(e){return w(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Gr;class D_ extends ao{static get __EMPTY_NODE(){return Gr}static set __EMPTY_NODE(e){Gr=e}compare(e,n){return Dn(e.name,n.name)}isDefinedOn(e){throw mi("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return U.MIN}maxPost(){return new U(Sn,Gr)}makePost(e,n){return w(typeof e=="string","KeyIndex indexValue must always be a string."),new U(e,Gr)}toString(){return".key"}}const ti=new D_;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ta;function BS(t){Ta=t}const L_=function(t){return typeof t=="number"?"number:"+__(t):"string:"+t},$_=function(t){if(t.isLeafNode()){const e=t.val();w(typeof e=="string"||typeof e=="number"||typeof e=="object"&&yt(e,".sv"),"Priority must be a string or number.")}else w(t===Ta||t.isEmpty(),"priority of unexpected type.");w(t===Ta||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let If;class ye{constructor(e,n=ye.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=n,this.lazyHash_=null,w(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),$_(this.priorityNode_)}static set __childrenNodeConstructor(e){If=e}static get __childrenNodeConstructor(){return If}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new ye(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:ye.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return H(e)?this:B(e)===".priority"?this.priorityNode_:ye.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,n){return null}updateImmediateChild(e,n){return e===".priority"?this.updatePriority(n):n.isEmpty()&&e!==".priority"?this:ye.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,n).updatePriority(this.priorityNode_)}updateChild(e,n){const i=B(e);return i===null?n:n.isEmpty()&&i!==".priority"?this:(w(i!==".priority"||Jt(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(i,ye.__childrenNodeConstructor.EMPTY_NODE.updateChild(re(e),n)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,n){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+L_(this.priorityNode_.val())+":");const n=typeof this.value_;e+=n+":",n==="number"?e+=__(this.value_):e+=this.value_,this.lazyHash_=h_(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===ye.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof ye.__childrenNodeConstructor?-1:(w(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const n=typeof e.value_,i=typeof this.value_,r=ye.VALUE_TYPE_ORDER.indexOf(n),s=ye.VALUE_TYPE_ORDER.indexOf(i);return w(r>=0,"Unknown leaf type: "+n),w(s>=0,"Unknown leaf type: "+i),r===s?i==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:s-r}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const n=e;return this.value_===n.value_&&this.priorityNode_.equals(n.priorityNode_)}else return!1}}ye.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B_(t){return{type:"value",snapshotNode:t}}function hi(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function hr(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function dr(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function QS(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lo(t,e){return{eventCache:t,serverCache:e}}function Yi(t,e,n,i){return lo(new Rn(e,n,i),t.serverCache)}function j_(t,e,n,i){return lo(t.eventCache,new Rn(e,n,i))}function Oa(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function An(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lc(t,e){return q_(e,t)}function fO(t,e,n,i,r){w(i>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:r}),r&&(t.visibleWrites=Xi(t.visibleWrites,e,n)),t.lastWriteId=i}function hO(t,e,n,i){w(i>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:i,visible:!0}),t.visibleWrites=Ra(t.visibleWrites,e,n),t.lastWriteId=i}function dO(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function _O(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);w(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let r=i.visible,s=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&pO(a,i.path)?r=!1:Xe(i.path,a.path)&&(s=!0)),o--}if(r){if(s)return gO(t),!0;if(i.snap)t.visibleWrites=Of(t.visibleWrites,i.path);else{const a=i.children;Te(a,l=>{t.visibleWrites=Of(t.visibleWrites,fe(i.path,l))})}return!0}else return!1}function pO(t,e){if(t.snap)return Xe(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Xe(fe(t.path,n),e))return!0;return!1}function gO(t){t.visibleWrites=V_(t.allWrites,mO,Y()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function mO(t){return t.visible}function V_(t,e,n){let i=lt.empty();for(let r=0;r<t.length;++r){const s=t[r];if(e(s)){const o=s.path;let a;if(s.snap)Xe(n,o)?(a=De(n,o),i=Xi(i,a,s.snap)):Xe(o,n)&&(a=De(o,n),i=Xi(i,Y(),s.snap.getChild(a)));else if(s.children){if(Xe(n,o))a=De(n,o),i=Ra(i,a,s.children);else if(Xe(o,n))if(a=De(o,n),H(a))i=Ra(i,Y(),s.children);else{const l=ai(s.children,B(a));if(l){const c=l.getChild(re(a));i=Xi(i,Y(),c)}}}else throw mi("WriteRecord should have .snap or .children")}}return i}function z_(t,e,n,i,r){if(!i&&!r){const s=Ln(t.visibleWrites,e);if(s!=null)return s;{const o=Yt(t.visibleWrites,e);if(xa(o))return n;if(n==null&&!Aa(o,Y()))return null;{const a=n||M.EMPTY_NODE;return _i(o,a)}}}else{const s=Yt(t.visibleWrites,e);if(!r&&xa(s))return n;if(!r&&n==null&&!Aa(s,Y()))return null;{const o=function(c){return(c.visible||r)&&(!i||!~i.indexOf(c.writeId))&&(Xe(c.path,e)||Xe(e,c.path))},a=V_(t.allWrites,o,e),l=n||M.EMPTY_NODE;return _i(a,l)}}}function vO(t,e,n){let i=M.EMPTY_NODE;const r=Ln(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(he,(s,o)=>{i=i.updateImmediateChild(s,o)}),i;if(n){const s=Yt(t.visibleWrites,e);return n.forEachChild(he,(o,a)=>{const l=_i(Yt(s,new J(o)),a);i=i.updateImmediateChild(o,l)}),Rf(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const s=Yt(t.visibleWrites,e);return Rf(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function yO(t,e,n,i,r){w(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=fe(e,n);if(Aa(t.visibleWrites,s))return null;{const o=Yt(t.visibleWrites,s);return xa(o)?r.getChild(n):_i(o,r.getChild(n))}}function EO(t,e,n,i){const r=fe(e,n),s=Ln(t.visibleWrites,r);if(s!=null)return s;if(i.isCompleteForChild(n)){const o=Yt(t.visibleWrites,r);return _i(o,i.getNode().getImmediateChild(n))}else return null}function bO(t,e){return Ln(t.visibleWrites,e)}function wO(t,e,n,i,r,s,o){let a;const l=Yt(t.visibleWrites,e),c=Ln(l,Y());if(c!=null)a=c;else if(n!=null)a=_i(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],f=o.getCompare(),h=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=h.getNext();for(;p&&u.length<r;)f(p,i)!==0&&u.push(p),p=h.getNext();return u}else return[]}function IO(){return{visibleWrites:lt.empty(),allWrites:[],lastWriteId:-1}}function Ts(t,e,n,i){return z_(t.writeTree,t.treePath,e,n,i)}function cc(t,e){return vO(t.writeTree,t.treePath,e)}function Af(t,e,n,i){return yO(t.writeTree,t.treePath,e,n,i)}function Ss(t,e){return bO(t.writeTree,fe(t.treePath,e))}function CO(t,e,n,i,r,s){return wO(t.writeTree,t.treePath,e,n,i,r,s)}function uc(t,e,n){return EO(t.writeTree,t.treePath,e,n)}function G_(t,e){return q_(fe(t.treePath,e),t.writeTree)}function q_(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let As;function qO(t){w(!As,"__referenceConstructor has already been defined"),As=t}function KO(){return w(As,"Reference.ts has not been loaded"),As}let YO=1;class Df{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ie(null),this.pendingWriteTree_=IO(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function XO(t,e,n,i,r){return fO(t.pendingWriteTree_,e,n,i,r),r?Oi(t,new On(sc(),e,n)):[]}function QO(t,e,n,i){hO(t.pendingWriteTree_,e,n,i);const r=ie.fromObject(n);return Oi(t,new di(sc(),e,r))}function mn(t,e,n=!1){const i=dO(t.pendingWriteTree_,e);if(_O(t.pendingWriteTree_,e)){let s=new ie(null);return i.snap!=null?s=s.set(Y(),!0):Te(i.children,o=>{s=s.set(new J(o),!0)}),Oi(t,new Cs(i.path,s,n))}else return[]}function uo(t,e,n){return Oi(t,new On(oc(),e,n))}function JO(t,e,n){const i=ie.fromObject(n);return Oi(t,new di(oc(),e,i))}function ZO(t,e){return Oi(t,new pr(oc(),e))}function eR(t,e,n){const i=dc(t,n);if(i){const r=_c(i),s=r.path,o=r.queryId,a=De(s,e),l=new pr(ac(o),a);return pc(t,s,l)}else return[]}function Na(t,e,n,i,r=!1){const s=e._path,o=t.syncPointTree_.get(s);let a=[];if(o&&(e._queryIdentifier==="default"||Z_(o,e))){const l=GO(o,e,n,i);WO(o)&&(t.syncPointTree_=t.syncPointTree_.remove(s));const c=l.removed;if(a=l.events,!r){const u=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,f=t.syncPointTree_.findOnPath(s,(h,p)=>Zt(p));if(u&&!f){const h=t.syncPointTree_.subtree(s);if(!h.isEmpty()){const p=iR(h);for(let E=0;E<p.length;++E){const b=p[E],P=b.query,W=ip(t,b);t.listenProvider_.startListening(Qi(P),xs(t,P),W.hashFn,W.onComplete)}}}!f&&c.length>0&&!i&&(u?t.listenProvider_.stopListening(Qi(e),null):c.forEach(h=>{const p=t.queryToTagMap.get(fo(h));t.listenProvider_.stopListening(Qi(h),p)}))}rR(t,c)}return a}function tR(t,e,n,i){const r=dc(t,i);if(r!=null){const s=_c(r),o=s.path,a=s.queryId,l=De(o,e),c=new On(ac(a),l,n);return pc(t,o,c)}else return[]}function nR(t,e,n,i){const r=dc(t,i);if(r){const s=_c(r),o=s.path,a=s.queryId,l=De(o,e),c=ie.fromObject(n),u=new di(ac(a),l,c);return pc(t,o,u)}else return[]}function Lf(t,e,n,i=!1){const r=e._path;let s=null,o=!1;t.syncPointTree_.foreachOnPath(r,(h,p)=>{const E=De(h,r);s=s||ni(p,E),o=o||Zt(p)});let a=t.syncPointTree_.get(r);a?(o=o||Zt(a),s=s||ni(a,Y())):(a=new BO,t.syncPointTree_=t.syncPointTree_.set(r,a));let l;s!=null?l=!0:(l=!1,s=M.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((p,E)=>{const b=ni(E,Y());b&&(s=s.updateImmediateChild(p,b))}));const c=Z_(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=fo(e);w(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=sR();t.queryToTagMap.set(h,p),t.tagToQueryMap.set(p,h)}const u=lc(t.pendingWriteTree_,r);let f=zO(a,e,n,u,s,l);if(!c&&!o&&!i){const h=J_(a,e);f=f.concat(oR(t,e,h))}return f}function ep(t,e,n){const r=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=De(o,e),c=ni(a,l);if(c)return c});return z_(r,e,s,n,!0)}function Oi(t,e){return tp(e,t.syncPointTree_,null,lc(t.pendingWriteTree_,Y()))}function tp(t,e,n,i){if(H(t.path))return np(t,e,n,i);{const r=e.get(Y());n==null&&r!=null&&(n=ni(r,Y()));let s=[];const o=B(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=G_(i,o);s=s.concat(tp(a,l,c,u))}return r&&(s=s.concat(hc(r,t,i,n))),s}}function np(t,e,n,i){const r=e.get(Y());n==null&&r!=null&&(n=ni(r,Y()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=G_(i,o),u=t.operationForChild(o);u&&(s=s.concat(np(u,a,l,c)))}),r&&(s=s.concat(hc(r,t,i,n))),s}function ip(t,e){const n=e.query,i=xs(t,n);return{hashFn:()=>(LO(e)||M.EMPTY_NODE).hash(),onComplete:r=>{if(r==="ok")return i?eR(t,n._path,i):ZO(t,n._path);{const s=QT(r,n);return Na(t,n,null,s)}}}}function xs(t,e){const n=fo(e);return t.queryToTagMap.get(n)}function fo(t){return t._path.toString()+"$"+t._queryIdentifier}function dc(t,e){return t.tagToQueryMap.get(e)}function _c(t){const e=t.indexOf("$");return w(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new J(t.substr(0,e))}}function pc(t,e,n){const i=t.syncPointTree_.get(e);w(i,"Missing sync point for query tag that we're tracking");const r=lc(t.pendingWriteTree_,e);return hc(i,n,r,null)}function iR(t){return t.fold((e,n,i)=>{if(n&&Zt(n))return[co(n)];{let r=[];return n&&(r=Q_(n)),Te(i,(s,o)=>{r=r.concat(o)}),r}})}function Qi(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(KO())(t._repo,t._path):t}function rR(t,e){for(let n=0;n<e.length;++n){const i=e[n];if(!i._queryParams.loadsAllData()){const r=fo(i),s=t.queryToTagMap.get(r);t.queryToTagMap.delete(r),t.tagToQueryMap.delete(s)}}}function sR(){return YO++}function oR(t,e,n){const i=e._path,r=xs(t,e),s=ip(t,n),o=t.listenProvider_.startListening(Qi(e),r,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(i);if(r)w(!Zt(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,f)=>{if(!H(c)&&u&&Zt(u))return[co(u).query];{let h=[];return u&&(h=h.concat(Q_(u).map(p=>p.query))),Te(f,(p,E)=>{h=h.concat(E)}),h}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(Qi(u),xs(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CR="repo_interrupt",TR=25;class SR{constructor(e,n,i,r){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=r,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new wR,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Is(),this.transactionQueueTree_=new yc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function OR(t,e,n){if(t.stats_=Ql(t.repoInfo_),t.forceRestClient_||tS())t.server_=new ws(t.repoInfo_,(i,r,s,o)=>{Ff(t,i,r,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Uf(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{be(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new St(t.repoInfo_,e,(i,r,s,o)=>{Ff(t,i,r,s,o)},i=>{Uf(t,i)},i=>{AR(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=oS(t.repoInfo_,()=>new sO(t.stats_,t.server_)),t.infoData_=new eO,t.infoSyncTree_=new Df({startListening:(i,r,s,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=uo(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Tc(t,"connected",!1),t.serverSyncTree_=new Df({startListening:(i,r,s,o)=>(t.server_.listen(i,s,r,(a,l)=>{const c=o(a,l);xt(t.eventQueue_,i._path,c)}),[]),stopListening:(i,r)=>{t.server_.unlisten(i,r)}})}function RR(t){const n=t.infoData_.getNode(new J(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Cc(t){return aR({timestamp:RR(t)})}function Ff(t,e,n,i,r){t.dataUpdateCount++;const s=new J(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(r)if(i){const l=fs(n,c=>Ie(c));o=nR(t.serverSyncTree_,s,l,r)}else{const l=Ie(n);o=tR(t.serverSyncTree_,s,l,r)}else if(i){const l=fs(n,c=>Ie(c));o=JO(t.serverSyncTree_,s,l)}else{const l=Ie(n);o=uo(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=gr(t,s)),xt(t.eventQueue_,a,o)}function Uf(t,e){Tc(t,"connected",e),e===!1&&kR(t)}function AR(t,e){Te(e,(n,i)=>{Tc(t,n,i)})}function Tc(t,e,n){const i=new J("/.info/"+e),r=Ie(n);t.infoData_.updateSnapshot(i,r);const s=uo(t.infoSyncTree_,i,r);xt(t.eventQueue_,i,s)}function hp(t){return t.nextWriteId_++}function xR(t,e,n,i){Sc(t,"update",{path:e.toString(),value:n});let r=!0;const s=Cc(t),o={};if(Te(n,(a,l)=>{r=!1,o[a]=rp(fe(e,a),Ie(l),t.serverSyncTree_,s)}),r)we("update() called with empty data.  Don't do anything."),Hf(t,i,"ok",void 0);else{const a=hp(t),l=QO(t.serverSyncTree_,e,o,a);Ic(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const f=c==="ok";f||$e("update at "+e+" failed: "+c);const h=mn(t.serverSyncTree_,a,!f),p=h.length>0?gr(t,e):e;xt(t.eventQueue_,p,h),Hf(t,i,c,u)}),Te(n,c=>{const u=mp(t,fe(e,c));gr(t,u)}),xt(t.eventQueue_,e,[])}}function kR(t){Sc(t,"onDisconnectEvents");const e=Cc(t),n=Is();Sa(t.onDisconnect_,Y(),(r,s)=>{const o=rp(r,s,t.serverSyncTree_,e);H_(n,r,o)});let i=[];Sa(n,Y(),(r,s)=>{i=i.concat(uo(t.serverSyncTree_,r,s));const o=mp(t,r);gr(t,o)}),t.onDisconnect_=Is(),xt(t.eventQueue_,Y(),i)}function PR(t,e,n){let i;B(e._path)===".info"?i=Lf(t.infoSyncTree_,e,n):i=Lf(t.serverSyncTree_,e,n),up(t.eventQueue_,e._path,i)}function Bf(t,e,n){let i;B(e._path)===".info"?i=Na(t.infoSyncTree_,e,n):i=Na(t.serverSyncTree_,e,n),up(t.eventQueue_,e._path,i)}function NR(t){t.persistentConnection_&&t.persistentConnection_.interrupt(CR)}function Sc(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),we(n,...e)}function Hf(t,e,n,i){e&&Si(()=>{if(n==="ok")e(null);else{const r=(n||"error").toUpperCase();let s=r;i&&(s+=": "+i);const o=new Error(s);o.code=r,e(o)}})}function dp(t,e,n){return ep(t.serverSyncTree_,e,n)||M.EMPTY_NODE}function Oc(t,e=t.transactionQueueTree_){if(e||_o(t,e),Ri(e)){const n=pp(t,e);w(n.length>0,"Sending zero length transaction queue"),n.every(r=>r.status===0)&&MR(t,Pr(e),n)}else op(e)&&ho(e,n=>{Oc(t,n)})}function MR(t,e,n){const i=n.map(c=>c.currentWriteId),r=dp(t,e,i);let s=r;const o=r.hash();for(let c=0;c<n.length;c++){const u=n[c];w(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const f=De(e,u.path);s=s.updateChild(f,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,c=>{Sc(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const f=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(mn(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&f.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();_o(t,Ec(t.transactionQueueTree_,e)),Oc(t,t.transactionQueueTree_),xt(t.eventQueue_,e,u);for(let h=0;h<f.length;h++)Si(f[h])}else{if(c==="datastale")for(let f=0;f<n.length;f++)n[f].status===3?n[f].status=4:n[f].status=0;else{$e("transaction at "+l.toString()+" failed: "+c);for(let f=0;f<n.length;f++)n[f].status=4,n[f].abortReason=c}gr(t,e)}},o)}function gr(t,e){const n=_p(t,e),i=Pr(n),r=pp(t,n);return DR(t,r,i),i}function DR(t,e,n){if(e.length===0)return;const i=[];let r=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=De(n,l.path);let u=!1,f;if(w(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,f=l.abortReason,r=r.concat(mn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=TR)u=!0,f="maxretry",r=r.concat(mn(t.serverSyncTree_,l.currentWriteId,!0));else{const h=dp(t,l.path,o);l.currentInputSnapshot=h;const p=e[a].update(h.val());if(p!==void 0){wc("transaction failed: Data returned ",p,l.path);let E=Ie(p);typeof p=="object"&&p!=null&&yt(p,".priority")||(E=E.updatePriority(h.getPriority()));const P=l.currentWriteId,W=Cc(t),q=uR(E,h,W);l.currentOutputSnapshotRaw=E,l.currentOutputSnapshotResolved=q,l.currentWriteId=hp(t),o.splice(o.indexOf(P),1),r=r.concat(XO(t.serverSyncTree_,l.path,q,l.currentWriteId,l.applyLocally)),r=r.concat(mn(t.serverSyncTree_,P,!0))}else u=!0,f="nodata",r=r.concat(mn(t.serverSyncTree_,l.currentWriteId,!0))}xt(t.eventQueue_,n,r),r=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(f==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(f),!1,null))))}_o(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)Si(i[a]);Oc(t,t.transactionQueueTree_)}function _p(t,e){let n,i=t.transactionQueueTree_;for(n=B(e);n!==null&&Ri(i)===void 0;)i=Ec(i,n),e=re(e),n=B(e);return i}function pp(t,e){const n=[];return gp(t,e,n),n.sort((i,r)=>i.order-r.order),n}function gp(t,e,n){const i=Ri(e);if(i)for(let r=0;r<i.length;r++)n.push(i[r]);ho(e,r=>{gp(t,r,n)})}function _o(t,e){const n=Ri(e);if(n){let i=0;for(let r=0;r<n.length;r++)n[r].status!==2&&(n[i]=n[r],i++);n.length=i,sp(e,n.length>0?n:void 0)}ho(e,i=>{_o(t,i)})}function mp(t,e){const n=Pr(_p(t,e)),i=Ec(t.transactionQueueTree_,e);return hR(i,r=>{Go(t,r)}),Go(t,i),ap(i,r=>{Go(t,r)}),n}function Go(t,e){const n=Ri(e);if(n){const i=[];let r=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(w(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(w(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),r=r.concat(mn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?sp(e,void 0):n.length=s+1,xt(t.eventQueue_,Pr(e),r);for(let o=0;o<i.length;o++)Si(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function LR(t){let e="";const n=t.split("/");for(let i=0;i<n.length;i++)if(n[i].length>0){let r=n[i];try{r=decodeURIComponent(r.replace(/\+/g," "))}catch{}e+="/"+r}return e}function $R(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const i=n.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):$e(`Invalid query segment '${n}' in query '${t}'`)}return e}const jf=function(t,e){const n=FR(t),i=n.namespace;n.domain==="firebase.com"&&At(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&n.domain!=="localhost"&&At("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||GT();const r=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new C_(n.host,n.secure,i,r,e,"",i!==n.subdomain),path:new J(n.pathString)}},FR=function(t){let e="",n="",i="",r="",s="",o=!0,a="https",l=443;if(typeof t=="string"){let c=t.indexOf("//");c>=0&&(a=t.substring(0,c-1),t=t.substring(c+2));let u=t.indexOf("/");u===-1&&(u=t.length);let f=t.indexOf("?");f===-1&&(f=t.length),e=t.substring(0,Math.min(u,f)),u<f&&(r=LR(t.substring(u,f)));const h=$R(t.substring(Math.min(t.length,f)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const p=e.slice(0,c);if(p.toLowerCase()==="localhost")n="localhost";else if(p.split(".").length<=2)n=p;else{const E=e.indexOf(".");i=e.substring(0,E).toLowerCase(),n=e.substring(E+1),s=i}"ns"in h&&(s=h.ns)}return{host:e,port:l,domain:n,subdomain:i,secure:o,scheme:a,pathString:r,namespace:s}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vp{constructor(e,n,i,r){this.eventType=e,this.eventRegistration=n,this.snapshot=i,this.prevName=r}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+be(this.snapshot.exportVal())}}class yp{constructor(e,n,i){this.eventRegistration=e,this.error=n,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rc{constructor(e,n,i,r){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=r}get key(){return H(this._path)?null:Zl(this._path)}get ref(){return new Pt(this._repo,this._path)}get _queryIdentifier(){const e=Tf(this._queryParams),n=Yl(e);return n==="{}"?"default":n}get _queryObject(){return Tf(this._queryParams)}isEqual(e){if(e=ut(e),!(e instanceof Rc))return!1;const n=this._repo===e._repo,i=ec(this._path,e._path),r=this._queryIdentifier===e._queryIdentifier;return n&&i&&r}toJSON(){return this.toString()}toString(){return this._repo.toString()+AS(this._path)}}class Pt extends Rc{constructor(e,n){super(e,n,new rc,!1)}get parent(){const e=N_(this._path);return e===null?null:new Pt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class mr{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new J(e),i=ks(this.ref,e);return new mr(this._node.getChild(n),i,he)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,r)=>e(new mr(r,ks(this.ref,i),he)))}hasChild(e){const n=new J(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ep(t,e){return t=ut(t),t._checkNotDeleted("ref"),e!==void 0?ks(t._root,e):t._root}function ks(t,e){return t=ut(t),B(t._path)===null?ER("child","path",e,!1):cp("child","path",e,!1),new Pt(t._repo,fe(t._path,e))}function BR(t,e){yR("update",e,t._path,!1);const n=new zs;return xR(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}class Ac{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new vp("value",this,new mr(e.snapshotNode,new Pt(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new yp(this,e,n):null}matches(e){return e instanceof Ac?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class xc{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new yp(this,e,n):null}createEvent(e,n){w(e.childName!=null,"Child events should have a childName.");const i=ks(new Pt(n._repo,n._path),e.childName),r=n._queryParams.getIndex();return new vp(e.type,this,new mr(e.snapshotNode,i,r),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof xc?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function HR(t,e,n,i,r){let s;if(typeof i=="object"&&(s=void 0,r=i),typeof i=="function"&&(s=i),r&&r.onlyOnce){const l=n,c=(u,f)=>{Bf(t._repo,t,a),l(u,f)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new UR(n,s||void 0),a=e==="value"?new Ac(o):new xc(e,o);return PR(t._repo,t,a),()=>Bf(t._repo,t,a)}function jR(t,e,n,i){return HR(t,"value",e,n,i)}HO(Pt);qO(Pt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qt(FA,UA,"app");const BA={apiKey:"AIzaSyCY5kWWn1FgxwqQeHacq-ahovHFrGMkfpo",authDomain:"our-odyssey.firebaseapp.com",projectId:"our-odyssey",storageBucket:"our-odyssey.appspot.com",messagingSenderId:"959052027883",appId:"1:959052027883:web:45b0ef7a2baa88e37dabae",measurementId:"G-SEJXSNP0G6"};ed(BA);const wp=rv(IA);wp.use($A);wp.mount("#app");
